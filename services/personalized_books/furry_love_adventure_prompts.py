...
FURRY_LOVE_ADVENTURE_SCENES = [
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, waking up in bed, stretching with a big smile, wearing {pajama_desc}, looking down at the foot of the bed. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, curled up at the foot of the bed, head raised looking at the child with bright excited eyes, tail starting to wag. ACTION: The child wakes up and discovers their pet waiting at the foot of the bed, both sharing an excited morning look. SETTING: Cozy children's bedroom WIDE VIEW, morning sunlight streaming through window, colorful posters on walls, toys on shelves. ATMOSPHERE: Exciting morning, warm golden sunlight, anticipation of adventure. STRICT: Only ONE child in bed, ONE pet at foot of bed, cozy bedroom scene. {style}",
        "text_position": "split"
    },
    {
        "id": 2,
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing at the front door wearing {adventure_outfit}, excited determined expression, one hand on the door handle ready to go. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, standing by the door spinning in circles with excitement, tail wagging fast, looking up at the child eagerly. ACTION: Child opens the front door ready for adventure while the pet spins with excitement beside them, both eager to leave. SETTING: Home entryway WIDE VIEW, front door with sunlight streaming in, coat hooks on wall, shoes lined up, bright cheerful morning outside. ATMOSPHERE: Departure excitement, bright morning energy, adventure awaits. STRICT: Only ONE child, ONE excited pet, doorway departure scene. {style}",
        "text_position": "split"
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, crouching down to crawl under a gap in an old wooden fence, wearing {adventure_outfit} now slightly damp and muddy, determined adventurous expression, peeking through to the other side. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, already halfway through the gap in the fence, squeezing under with excited expression, body low to the ground. ACTION: Child and pet sneak under an old wooden fence into a secret area, a golden butterfly visible flying just ahead on the other side. SETTING: Old wooden fence WIDE VIEW, a gap at the bottom big enough to crawl through, wild ivy and flowers growing on the fence, mysterious green glow from the other side, golden butterfly ahead. ATMOSPHERE: Sneaky adventure, forbidden territory excitement, mysterious light from beyond the fence. STRICT: Only ONE child crawling under fence, ONE pet squeezing through, adventure discovery scene. {style}",
        "text_position": "split"
    },
    {
        "id": 8,
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing in amazement in a magical secret garden, wearing {adventure_outfit}, mouth open, head tilted back looking at giant flowers towering above, arms slightly outstretched in wonder. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sniffing a giant purple flower, sneezing with a cloud of colorful pollen around its face, surprised expression. ACTION: Child and pet discover a magical secret garden filled with oversized colorful flowers, the child is in awe while the pet sniffs a giant flower. SETTING: Secret garden WIDE VIEW, enormous flowers of every color towering overhead, magical light filtering through petals, stone path winding through, butterflies and sparkles. ATMOSPHERE: Magical wonderland, kaleidoscope of colors, warm enchanted light, fairy tale atmosphere. STRICT: Only ONE child, ONE pet, magical oversized garden, fantasy discovery scene. {style}",
        "text_position": "split"
    },
    {
        "id": 9,
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, kneeling beside a large tree, wearing {adventure_outfit}, hands digging in dirt around an old wooden chest with golden ornaments, excited discovery expression. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, digging enthusiastically beside the child with front paws, dirt flying behind, helping to unearth the chest, determined expression. ACTION: Child and pet dig together to unearth an old treasure chest found among the roots of a giant tree in the secret garden. SETTING: Base of an enormous ancient tree WIDE VIEW, gnarled roots forming a natural hideaway, an old wooden chest half-buried in soil with golden metal corners visible, magical garden around. ATMOSPHERE: Treasure discovery excitement, warm dappled light through canopy, magical anticipation. STRICT: Only ONE child digging, ONE pet helping dig, one treasure chest, discovery scene. {style}",
        "text_position": "split"
    },
    {
        "id": 10,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, walking along a narrow forest path holding a map in one hand, wearing {adventure_outfit}, looking ahead with determination. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, walking close beside the child, alert and protective, ears perked forward, stepping carefully on the path. ACTION: Child and pet walk together through a natural tunnel of tree branches following a treasure map, a golden butterfly glowing ahead of them. SETTING: Forest tunnel path WIDE VIEW, arching tree branches creating a green canopy tunnel, dappled golden light filtering through leaves, narrow dirt path, golden butterfly glowing ahead. ATMOSPHERE: Enchanted forest adventure, green and gold light, mysterious but inviting path ahead. STRICT: Only ONE child walking, ONE pet beside them, forest tunnel path scene. {style}",
        "text_position": "split"
    },
    {
        "id": 12,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, running across a wooden bridge over a stream, wearing {adventure_outfit}, beaming with joy and pride, one hand resting on the pet's back as they run together. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, running alongside the child on the bridge, tail held high and wagging, brave and confident, matching the child's pace perfectly. ACTION: Child and pet run across the wooden bridge together side by side, both brave and happy, the child's hand on the pet's back for encouragement. SETTING: Wooden bridge WIDE VIEW, crystal stream below with sunlight sparkling on water, green banks on both sides, forest canopy above, golden light rays. ATMOSPHERE: Trust and shared courage, warm joyful energy, golden light streaming through trees, bonding moment of bravery. STRICT: Only ONE child running, ONE full-size pet running beside them on the bridge, both characters side by side crossing the bridge — the pet walks and runs on its own four paws. {style}",
        "text_position": "split"
    },
    {
        "id": 14,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, inside a crystal cave, wearing {adventure_outfit}, kneeling in front of a smooth glowing stone, reading it with wide emotional eyes, hand touching the stone gently. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting beside the child inside the cave, head tilted as if listening to the words being read, attentive loving expression. ACTION: Child reads an inscription on a glowing stone inside the crystal cave while the pet sits attentively beside them, both moved by the message. SETTING: Inside crystal cave WIDE VIEW, walls covered in multicolored crystals reflecting light everywhere, smooth stone at the back, soft magical glow illuminating the cave. ATMOSPHERE: Magical revelation, rainbow crystal light, emotional discovery, warm awe. STRICT: Only ONE child reading stone, ONE pet beside them, inside crystal cave scene. {style}",
        "text_position": "split"
    },
    {
        "id": 16,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: @image1 = copy exactly @image1: clean {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, wearing {clean_pajama_desc}, curled up on a cozy sofa, eyes closing sleepily, one hand resting on the pet, a star medallion visible on the coffee table, peaceful smile. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, clean and fluffy after a bath, curled up right next to the child on the sofa, head resting on the child's lap, eyes already closed, deeply content. ACTION: Clean child and pet fall asleep together on the couch after their adventure, both peaceful and content, dreaming of tomorrow. SETTING: Cozy living room evening WIDE VIEW, soft sofa with blankets, warm lamp light, star medallion on coffee table glowing softly, window showing stars outside, family photos on wall. ATMOSPHERE: Perfect peaceful ending, warm amber lamp light, deep contentment, love and friendship, dreamlike serenity. STRICT: Only ONE child on sofa, ONE pet beside them, cozy evening sleep scene. {style}",
        "text_position": "split"
    }
]
