...
def build_human_preview_prompt(human_desc: str, gender_word: str = "boy", **kwargs) -> str:
    outfit = ADVENTURE_OUTFIT_GIRL if gender_word == "girl" else ADVENTURE_OUTFIT_BOY
    return (
