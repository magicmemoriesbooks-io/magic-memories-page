...
FURRY_LOVE_SCENES = [
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. PET: {pet_desc}, sitting in a nursery doorway, head tilted curiously, tail slightly wagging. ACTION: The dog sits alone at the threshold of a freshly painted nursery, peeking inside with curiosity, nose raised sniffing the air. SETTING: Nursery doorway WIDE VIEW, pastel walls behind, a crib with mobile, soft blankets, warm sunlight through curtains, paint cans and baby items visible. ATMOSPHERE: Anticipation, warm golden afternoon light, cozy home feeling, everything ready for the new {gender_word}. STRICT: Only ONE dog alone in the scene, before the {gender_word} arrives home, peaceful domestic scene. {style}",
        "text_position": "split"
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A 5-month-old {gender_word} with {eye_desc} eyes{glasses_desc} wearing only a diaper, sitting in a small baby bathtub, splashing water joyfully with both hands, laughing with mouth wide open, bare chest and diaper visible. PET: {pet_desc}, standing in the bathroom doorway, head tilted to one side, water droplets on nose, one paw raised, surprised but amused expression. ACTION: Baby splashes enthusiastically in bathtub sending water flying, a splash hits the dog's nose, both enjoying the chaos. SETTING: Bright bathroom WIDE VIEW, small baby bathtub with bubbles, rubber duck, water splashes in the air, towel on rack, warm lighting. ATMOSPHERE: Playful joy, bright cheerful lighting, water droplets catching light like sparkles. STRICT: Only ONE baby in tub wearing only a diaper, ONE dog at doorway, fun bath scene, joyful chaos. {style}",
        "text_position": "split"
    },
    {
        "id": 9,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A 10-month-old {gender_word} with {eye_desc} eyes{glasses_desc} sitting in a high chair, face covered in colorful food, hands messy with puree, giggling, dropping food over the side. PET: {pet_desc}, sitting right under the high chair, looking up with eager happy expression, tongue out, catching a piece of food, tail wagging fast. ACTION: Messy baby in high chair drops food while the dog happily catches it below, both thoroughly enjoying mealtime together. SETTING: Kitchen dining area WIDE VIEW, high chair, colorful baby food on tray and face, food bits on floor, cheerful kitchen background. ATMOSPHERE: Joyful messy fun, bright kitchen lighting, comedic and heartwarming. STRICT: Only ONE baby in high chair, ONE dog underneath, funny mealtime scene. {style}",
        "text_position": "split"
    },
    {
        "id": 14,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A 12-month-old {gender_word} with {eye_desc} eyes{glasses_desc} standing wobbly in the garden, wearing a cute light red t-shirt and tiny denim shorts, arm extended after throwing a small colorful ball, proud excited expression, bare feet on grass. PET: {pet_desc}, running back toward the toddler with a small ball in mouth, tail high, eyes bright and happy, mid-run. ACTION: Toddler plays fetch with the dog in the garden, the dog enthusiastically retrieves the ball that only went a short distance, the toddler claps excitedly. SETTING: Home garden WIDE VIEW, green grass, sunny day, the ball visible near the dog, fence and flowers in background, blue sky. ATMOSPHERE: Playful outdoor fun, bright sunny joyful energy, pure childhood happiness. STRICT: Only ONE toddler standing, ONE running dog with ball, outdoor play scene. {style}",
        "text_position": "split"
    },
    {
        "id": 18,
...
def _get_hair_growth_desc(scene_id: int, hair_color: str) -> str:
    ...
    if scene_id in (10, 11):
        return "and nearly bald smooth scalp with barely-there sparse fuzz, almost no hair"
    elif scene_id in (12, 13):
        return "and nearly bald with very sparse fine baby hair just starting to appear"
    elif scene_id in (14, 15):
        return f"and short fine {c} baby hair growing in" if c else "and short fine baby hair growing in"
    elif scene_id >= 16:
        return f"and short soft {c} baby hair" if c else "and short soft baby hair"
    return ""
