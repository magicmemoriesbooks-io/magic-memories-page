...
CENTINELA_AURORA_SCENES = [
    ...
    # ── SCENE 6 — Bosque de páginas de libros ────────────────────────────────
    {
        ...
        "prompt": (
            ...
            "ASTRO pads quietly through the enchanted forest path, electric blue ears perked upright, listening to the rustling whispered stories. "
    ...
    # ── SCENE 13 — El dibujo, el gigante se encoge ───────────────────────────
    {
        ...
        "prompt": (
            ...
            "OUTFIT: {outfit_desc}. "
            "COMPANION: {ASTRO_INLINE}. "
            "ACTION: {gender_word} holds out a colorful crayon drawing with a warm sincere smile, reaching up toward "
            "the stone giant who is shrinking and smiling through tears, the giant reaching down with one huge "
            "rocky finger to gently accept the gift, warm golden light spreading from the drawing. "
            "ASTRO sits a short distance away, watching the exchange with bright happy amber eyes and a small wag "
            "of the glowing tail. "
    ...
    # ── SCENE 16 — Astro ilumina, el niño limpia los engranajes ─────────────
    {
        ...
        "prompt": (
            ...
            "ASTRO holds its brilliant star-tipped tail high to illuminate the darkest corners of the room, "
            "electric blue light steady and unwavering. "
    ...
    # ── SCENE 18 — Despedida en el jardín, mensaje de Astro ─────────────────
    {
        ...
        "prompt": (
            ...
            "OUTFIT: {outfit_desc}. "
            "COMPANION: {ASTRO_INLINE}. "
            "ACTION: {gender_word} kneels in the moonlit garden, arms wrapped gently in a farewell embrace, "
            "eyes glistening with happy tears, the iridescent portal slowly closing behind in soft light. "
            "ASTRO stands on the ground before the child, star-tipped tail glowing beautifully bright, "
            "head raised and amber eyes full of warmth and gratitude as aurora colors fill the sky above. "
