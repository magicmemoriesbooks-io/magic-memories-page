...
FURRY_LOVE_ADULT_SCENES = [
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A {gender_word} adult ({age_display}) with {eye_desc} eyes{glasses_desc}{facial_hair_desc} sitting in the DRIVER SEAT on the LEFT side, hands on the steering wheel, smiling, looking at the road ahead through the windshield. PET: {pet_desc}, sitting in the BACK SEAT BEHIND the driver, head sticking out the rear passenger window, ears flapping in the wind, eyes squinting with joy, tongue out, enjoying the ride from the back. ACTION: EXTERIOR SIDE VIEW of the car on a country road: the adult clearly visible through the front windshield in the DRIVER SEAT, the pet's head sticking joyfully out of the REAR PASSENGER WINDOW in the back seat, both visible from outside the car. SETTING: Country road WIDE VIEW, mountains visible in the background, green trees lining the road, blue sky, warm sunlight on the car. ATMOSPHERE: Freedom and excitement, open road adventure, warm sunlight. STRICT: The adult is ALWAYS in the DRIVER SEAT at the front. The pet is ALWAYS in the BACK seat with head out the rear window. NEVER put the dog in the driver seat. The dog does NOT drive. ONE adult driving in front, ONE pet in rear window only. {style}",
        "text_position": "split"
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A {gender_word} adult ({age_display}) with {eye_desc} eyes{glasses_desc}{facial_hair_desc} bent over laughing uncontrollably, holding their stomach, eyes crinkled with tears of laughter, pure joy on their face. PET: {pet_desc}, jumping backwards in comical surprise, all four paws off the ground, startled wide-eyed expression, an acorn bouncing near its head. ACTION: The pet recoils in surprise as a squirrel drops an acorn on its head, while the human bursts into uncontrollable laughter, birds scattering from trees. SETTING: Forest trail WIDE VIEW, squirrel on branch above looking smug, birds flying away from treetops, acorn mid-bounce, dappled sunlight. ATMOSPHERE: Pure hilarious comedy, joyful laughter echoing through forest, bright warm light, slapstick humor. STRICT: Only ONE adult laughing, ONE pet jumping back, ONE squirrel above, comedic scene. {style}",
        "text_position": "split"
    },
    {
        "id": 8,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. HUMAN: A {gender_word} adult ({age_display}) with {eye_desc} eyes{glasses_desc}{facial_hair_desc} lying in a sleeping bag inside the tent, just waking up with a soft sleepy smile, propped up on one elbow, looking down fondly at the pet sleeping across their legs, morning light glowing through tent fabric. PET: {pet_desc}, sleeping sprawled across the human's legs inside the tent, completely relaxed, slightly snoring, paws twitching in a dream, adorable sleeping position. ACTION: The human wakes up in the tent to find the pet sleeping across their legs, a tender funny morning moment. SETTING: Inside the tent WIDE VIEW, warm morning light glowing through orange and green tent fabric, sleeping bag and pillow, cozy camping interior, suggestion of forest and birds outside. ATMOSPHERE: Tender morning warmth, gentle humor, cozy camping morning, soft filtered tent light, love and companionship. STRICT: Only ONE adult waking up in tent, ONE pet sleeping across their legs, morning tent scene. {style}",
        "text_position": "split"
    },
    {
        "id": 19,
...
CLOSING_SCENE = {
    "id": 20,
    "prompt": "Disney Pixar 3D style illustration. HUMAN: A {gender_word} adult ({age_display}) with {eye_desc} eyes{glasses_desc}{facial_hair_desc} sitting on a rock at a mountain overlook, seen from three-quarter angle, face visible with a peaceful grateful expression, warm golden sunset light on their face, backpack beside them. PET: {pet_desc}, sitting loyally beside the human on the overlook, leaning gently against the human's leg, calm happy expression, both gazing at the vast landscape below. ACTION: Human and pet sit together at a dramatic mountain overlook enjoying a spectacular golden sunset, a perfect ending to their adventure. SETTING: Dramatic mountain overlook WIDE VIEW, golden hour sky with warm orange and purple colors, vast valley and mountains below, pine trees framing the scene, epic cinematic composition. ATMOSPHERE: Epic emotional finale, golden cinematic light, deep bond and loyalty, adventure and love, perfect ending. STRICT: Only ONE adult sitting, ONE pet beside them, epic closing scene. {style}",
    "text_position": "none"
}

FRONT_COVER = {
    "prompt": "Disney Pixar 3D style illustration. HUMAN: A {gender_word} adult ({age_display}) with {eye_desc} eyes{glasses_desc}{facial_hair_desc}, full appearance matching @image1 exactly — preserve adult age, mature face proportions and wrinkles if present, sitting by a glowing campfire, wearing outdoor hiking clothes, warm happy smile, relaxed and enjoying the moment. PET: {pet_desc} exactly as in @image2, sitting beside the human at the campfire, happy and content, looking at the human with adoring eyes. ACTION: Human and pet share a cozy fun moment together around a crackling campfire in the mountains at golden hour, both relaxed and bonded, laughing and enjoying the adventure. SETTING: Mountain campsite WIDE VIEW with epic peaks in the background, pine trees around, warm twilight sky, glowing campfire light illuminating both characters warmly, tent visible in background. ATMOSPHERE: Warm cozy bonding, adventure and joy, golden fire light, magical mountain evening, deep friendship. STRICT: Only ONE adult {gender_word} and ONE pet, centered composition for book cover. Pure illustration only, zero text or lettering. {style}"
}
