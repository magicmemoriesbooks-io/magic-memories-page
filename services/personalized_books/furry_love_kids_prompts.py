...
FURRY_LOVE_KIDS_SCENES = [
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at the door at CENTER-LEFT of frame, exactly ONE pet sitting at CENTER-RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing at the open front door at CENTER-LEFT of frame, school backpack on shoulders, bending slightly to look back at the pet with a loving goodbye expression, one hand still on the door handle. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting on the floor at CENTER-RIGHT of frame, directly beside the doorway, large sad eyes looking up at the child, head slightly drooping, tail low, the picture of patient loyalty. TOGETHER: child stands at the open doorway saying goodbye while the pet sits beside them looking up with devotion, the outside world visible behind the child. SETTING: Home entryway WIDE VIEW, open front door with morning sunlight beyond, coat hooks on the wall, shoes on the mat, warm interior light. ATMOSPHERE: Bittersweet parting, morning warmth, loyal devotion. {style}",
        "text_position": "split"
    },
    {
        "id": 3,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT of frame, exactly ONE pet at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing just inside the front door at LEFT of frame, arms spread wide open, laughing with pure delight, school backpack slipping off one shoulder, leaning forward ready for the reunion. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, leaping with all four paws off the ground at RIGHT of frame, directly facing the child, ears back from the excitement, mouth open in a joyful grin, mid-jump reunion leap. TOGETHER: child opens arms wide as the pet launches toward them in the entryway, just inside the front door. SETTING: Home entryway WIDE VIEW, front door wide open behind the child, afternoon sunlight streaming in, school backpack on the floor, warm cozy interior. ATMOSPHERE: Pure explosive reunion joy, warm afternoon backlight, happiness overflowing. {style}",
        "text_position": "split"
    },
    {
        "id": 4,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT of frame mid-throw, exactly ONE pet at RIGHT of frame mid-run, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing at LEFT of frame with arm extended in a throwing motion, laughing with eyes crinkled, one foot forward in the follow-through of a throw, casual play clothes. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, at RIGHT of frame running at full speed away from the child, body stretched long in a galloping stride, ears back from speed, tail streaming, completely focused on chasing. TOGETHER: child throws from the LEFT while the pet races to the RIGHT, a colorful ball visible mid-arc between them. SETTING: Home garden WIDE VIEW, green lawn, colorful flowers along the fence, blue sky with a few clouds, warm afternoon sunlight casting short happy shadows. ATMOSPHERE: Energetic outdoor joy, bright golden afternoon light, carefree play. {style}",
        "text_position": "split"
    },
    {
        "id": 7,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT inside the fort, exactly ONE pet at RIGHT inside the fort, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, sitting cross-legged at LEFT inside a cozy blanket fort, holding a small flashlight that illuminates the interior, smiling with cozy contentment, a picture book open on the floor. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sprawled at RIGHT inside the same blanket fort, head up and alert like a true guardian, paws stretched forward, tail resting, looking out the blanket entrance with dignified importance. TOGETHER: child and pet share the snug interior of the blanket fort, the flashlight casting a warm golden glow on both. SETTING: Living room floor WIDE VIEW, the blanket fort constructed from sofa cushions and draped sheets, a flashlight glow within, rain visible through the window outside, grey sky beyond, warm and dry inside. ATMOSPHERE: Cozy rainy-day magic, warm golden flashlight glow vs grey rain outside, snug safe happiness. {style}",
        "text_position": "split"
    },
    {
        "id": 8,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child kneeling beside the tub at LEFT of frame, exactly ONE pet in the tub at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, kneeling on the bathroom floor at LEFT of frame beside a small bathtub, eyes squinted shut against a massive water splash, arms raised in defense, soaked from head to toe, laughing despite the chaos. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, standing in the small bathtub at RIGHT of frame, ears flat, looking betrayed and dignified despite being covered in bubbles, mid-shake sending a wall of water toward the child. TOGETHER: pet shakes a huge spray of water directly at the child who kneels helplessly laughing beside the tub. SETTING: Bright bathroom WIDE VIEW, small bathtub with bubbles overflowing, water droplets suspended in the air catching the bathroom light, towels knocked off the rack, rubber duck floating nearby. ATMOSPHERE: Hilarious wet chaos, bright bathroom light catching every water droplet, pure comedy. {style}",
        "text_position": "split"
    },
    {
        "id": 12,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT of frame as photographer, exactly ONE pet at RIGHT of frame as reluctant subject, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, crouching at LEFT of frame holding a phone or small camera up to their face, one eye shut and one eye at the viewfinder, grinning behind the device, clearly delighted by the result. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting at RIGHT of frame on an arrangement of colorful cushions, wearing a small flower crown at a slightly crooked angle, giving the camera the most long-suffering dignified unimpressed stare, sitting still in reluctant compliance. TOGETHER: child photographs the pet from a few feet away, the pet posing reluctantly on the improvised cushion studio backdrop. SETTING: Living room WIDE VIEW, colorful cushions arranged as backdrop, warm home light, a few fallen flower petals on the cushions, cheerful and creative mess. ATMOSPHERE: Comedy and creativity, warm home light, silly sweet fun. {style}",
        "text_position": "split"
    },
    {
        "id": 14,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT of frame dancing, exactly ONE pet at RIGHT of frame jumping, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, at LEFT of frame in the middle of an exuberant dance, arms flung wide, legs mid-skip, laughing with pure relief and happiness, eyes bright and joyful. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, at RIGHT of frame leaping and bounding with full healthy energy, all four paws off the ground, mouth open in a joyful grin, ears flying, completely recovered and bursting with life. TOGETHER: child and pet celebrate and dance together across the living room, both in joyful mid-motion, a bag of treats visible on the coffee table behind them. SETTING: Living room WIDE VIEW, furniture pushed to the sides for the dance, warm afternoon sunlight flooding in, a small treat bag on the table, cozy home atmosphere. ATMOSPHERE: Explosive relief and celebration, bright warm sunshine, pure unbridled happiness. {style}",
        "text_position": "split"
    },
    {
        "id": 16,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child at LEFT of frame as proud host, exactly ONE pet at CENTER of frame performing, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, standing at LEFT of frame slightly to the side, arms crossed with a huge beaming proud smile, watching the pet perform, eyes crinkled with delight and pride. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, at CENTER of frame in a perfect spotlight moment, sitting upright on hind legs with one paw raised in the learned trick, chest out, expression theatrical and magnificent, as if performing for an audience of thousands. TOGETHER: child stands to the side beaming with pride as the pet performs their best trick in the imaginary spotlight between them. SETTING: Home garden or yard WIDE VIEW, a sunny Saturday afternoon, a simple 'stage' area of flat grass, warm golden afternoon light creating a natural spotlight effect, flowers and garden behind. ATMOSPHERE: Showtime pride and humor, warm golden spotlight light, pure joyful pride and comedy. {style}",
        "text_position": "split"
    },
    {
        "id": 18,
...
CLOSING_SCENE = {
    "id": 20,
    "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE child asleep in bed at CENTER-TOP of frame, exactly ONE pet asleep at the foot of the bed at CENTER-BOTTOM of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} ({age_display}), child face and proportions — match reference exactly{glasses_desc}, sleeping deeply in a cozy bed at CENTER of frame under a star-patterned blanket, peaceful angelic expression, one arm hanging loosely over the side. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, curled up peacefully at the foot of the same bed at BOTTOM of frame, chin resting on the child's ankles, eyes closed in deep contented sleep, tail curled around their body. TOGETHER: child sleeps in bed while the pet rests faithfully at their feet, both deeply asleep and connected, a year of memories on the walls around them. SETTING: Cozy bedroom at night WIDE VIEW, warm nightlight glow, stars visible through the window, colorful drawings and photos pinned to the wall showing moments of the year together, peaceful darkness. ATMOSPHERE: Perfect serene ending, warm nightlight glow, eternal friendship, protective love made visible in sleep. {style}",
    "text_position": "none"
}

FRONT_COVER = {
    "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE {gender_word} child and exactly ONE pet together at CENTER of frame, no other characters, pure illustration only, zero text. HUMAN: @image1 = copy exactly @image1: {gender_word}, full appearance matching @image1 exactly, kneeling at CENTER-LEFT of frame with both arms wrapped around the pet in a warm hug, eyes closed with a smile of pure happiness, casual play clothes. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, at CENTER-RIGHT of frame, leaning fully into the hug with eyes closed too, tail wagging, ears back from the warmth of the embrace, both of them captured in a perfect moment of best-friend love. TOGETHER: child and pet share a heartfelt hug at center frame, both eyes closed, both perfectly happy, in a simple joyful embrace. SETTING: Beautiful sunny garden WIDE VIEW, soft golden afternoon light creating a warm glow around them, green grass, a few wildflowers, warm bokeh background, clean centered book-cover composition. ATMOSPHERE: Pure warm love, golden backlight halo effect, timeless friendship, centered book cover quality. {style}"
}
