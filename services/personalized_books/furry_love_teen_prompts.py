...
FURRY_LOVE_TEEN_SCENES = [
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE small child at LEFT of frame, exactly ONE pet at RIGHT of frame, no extra characters, memory/flashback scene. HUMAN: @image1 = copy exactly @image1: small {gender_word} child around 6 years old, younger childhood version of the same face — match reference facial identity exactly, short and small, laughing joyfully, running at LEFT side of frame, arms open wide, pure happiness on face. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, young and energetic, running alongside the child at RIGHT side of frame, ears back from running speed, joyful bounding stride. TOGETHER: the child and pet run side by side across the open park, both carefree and inseparable. SETTING: Beautiful sunny park WIDE VIEW, green grass, warm golden afternoon light, soft dreamy hazy edges suggesting this is a childhood memory. ATMOSPHERE: Nostalgic warmth, golden memory glow, bittersweet happiness from the past. {style}",
        "text_position": "split"
    },
    {
        "id": 2,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager at LEFT of frame, exactly ONE pet at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, slouched on a beanbag chair at LEFT side of frame, phone glowing on face, headphones around neck, one hand loosely waving the pet away without looking up. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting on the floor at RIGHT side of frame, looking up at the teenager with large hopeful eyes, head tilted, tail wagging gently, patient and hopeful. TOGETHER: the pet sits just within arm's reach of the teen, who stares at the phone ignoring them. SETTING: Modern teenager bedroom WIDE VIEW, gaming posters, desk with computer, warm afternoon light through window. ATMOSPHERE: Gentle sadness, contrast between cold screen glow and warm loyal pet presence, quiet longing. {style}",
        "text_position": "split"
    },
    {
        "id": 3,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager at BACK of hallway, exactly ONE pet at FRONT of hallway running away, no extra characters, no floating hands. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, standing upright at the FAR END of the hallway, mouth open in shock, one arm extended forward in disbelief, feet planted on the ground. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sprinting at full speed toward the FOREGROUND of the hallway, a smartphone held carefully in its mouth, mischievous triumphant expression, ears back from speed, tail high. TOGETHER: the pet races away from the teenager down the long hallway, a clear distance of several meters between them. SETTING: Home hallway WIDE VIEW, doors along the sides, warm indoor lighting, morning atmosphere. ATMOSPHERE: Hilarious comedic chaos, mischievous energy, bright dynamic lighting. {style}",
        "text_position": "split"
    },
    {
        "id": 4,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager kneeling at LEFT of frame, exactly ONE pet under the table at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, kneeling on the floor at LEFT side of frame reaching one arm under the dining table, messy hair, laughing despite themselves, amused expression. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting under the table at RIGHT side of frame, drool-covered phone held between its front paws, playful guilty expression, tail wagging, big happy eyes looking at the teenager. TOGETHER: teen reaches toward the pet who sits smugly under the table with the drool-covered prize. SETTING: Dining room WIDE VIEW, chairs pushed aside, table legs framing the scene, warm home lighting. ATMOSPHERE: Comedic resolution, warm laughter, genuine fun moment. {style}",
        "text_position": "split"
    },
    {
        "id": 5,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager seated at LEFT of frame, exactly ONE pet lying across the keyboard at CENTER of frame, no other animals, pure illustration only. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, seated at the LEFT side of the desk, both hands raised in a helpless gesture, exasperated but amused smile, leaning back slightly from the keyboard. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, lying sprawled across the laptop keyboard at CENTER of the desk, completely relaxed, paws draped forward, content satisfied face looking up at the teen, tail hanging off one side. TOGETHER: the pet occupies the entire keyboard directly in front of the teenager, blocking all work. SETTING: Teen study desk WIDE VIEW, laptop with glowing blank screen, school books and notebooks, desk lamp, cozy evening atmosphere. ATMOSPHERE: Comedic frustration turning to amusement, warm desk lamp glow. {style}",
        "text_position": "split"
    },
    {
        "id": 6,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager at the desk, exactly ONE pet seated beside the chair, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, sitting at the desk facing the laptop, one hand on the keyboard typing, the other arm reaching down beside the chair with a gentle smile. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting on the floor directly beside the desk chair, eyes closed in bliss receiving a head pat, leaning into the touch, tail wagging gently, peaceful expression. TOGETHER: teen's hand rests on the pet's head just beside the chair, an absent-minded but warm gesture. SETTING: Study desk WIDE VIEW, laptop with homework on screen, warm desk lamp light, bedroom in background, evening. ATMOSPHERE: Small tender moment, quiet warmth breaking through distraction, soft lamplight. {style}",
        "text_position": "split"
    },
    {
        "id": 7,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager on floor at LEFT of frame, exactly ONE pet in its own bed at RIGHT of frame, no duplicate animals, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, crouching on the bedroom floor at LEFT of frame, shining a flashlight toward the RIGHT side of the room, eyes wide in shocked amusement, mouth open in disbelief at the discovery. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, lying in its pet bed at RIGHT of frame in the same room, surrounded by a collection of colorful stolen socks, a glove, and a cap piled around it, looking up at the teenager with the most innocent proud expression. TOGETHER: the flashlight beam connects the teen at LEFT to the pet's discovered treasure stash at RIGHT. SETTING: Teenager bedroom floor level WIDE VIEW, morning light from window, scattered personal items. ATMOSPHERE: Hilarious discovery, warm morning light, pure mischief revealed. {style}",
        "text_position": "split"
    },
    {
        "id": 8,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager kneeling at LEFT of frame, exactly ONE pet sitting at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, kneeling on the bedroom floor at LEFT of frame, holding a bunch of recovered socks and a cap in one arm, the other hand scratching the pet's ears, shaking head with a helpless warm grin. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting upright at RIGHT of frame beside the teenager, gazing up with the most angelic innocent expression, huge sparkling eyes, head tilted slightly, ears perked into the scratch, tail gently wagging. TOGETHER: teen scratches the pet's ears while the pet holds its best innocent face. SETTING: Bedroom floor WIDE VIEW, scattered socks around them, morning sunlight, cozy atmosphere. ATMOSPHERE: Loving humor, fake scolding with real affection, warm golden morning light. {style}",
        "text_position": "split"
    },
    {
        "id": 9,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE pet lying alone in the hallway, teenager barely visible as a silhouette through a door crack, no extra characters. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, lying alone on the hallway floor right against a closed bedroom door, head resting on front paws, nose pressed to the gap under the door, sad lonely eyes, droopy patient posture. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly, seen only as a dim silhouette visible through the door crack, sitting at a desk inside with headphones on, absorbed in a screen, unaware. TOGETHER: the pet waits in the dim hallway while warm light leaks from under the closed door separating them. SETTING: Home hallway WIDE VIEW, closed bedroom door, warm light leaking underneath, family photos on walls, evening atmosphere. ATMOSPHERE: Quiet loneliness, loyal devotion, contrast between warm screen light inside and dim hallway. {style}",
        "text_position": "split"
    },
    {
        "id": 10,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager kneeling at LEFT of frame, exactly ONE sick pet in a bed at RIGHT of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, kneeling on the floor at LEFT of frame, school backpack still on one shoulder, gently touching the pet's head with one hand, worried eyebrows furrowed, fully focused with genuine concern. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, curled up tightly in a small pet bed at RIGHT of frame, looking unwell and tired, droopy sad eyes, subdued still body language, vulnerable. TOGETHER: teen's hand rests gently on the sick pet's head, leaning close with worry. SETTING: Living room corner WIDE VIEW, small pet bed with soft blanket, school backpack on floor, quiet afternoon light, no screens visible. ATMOSPHERE: Worry and concern, sudden emotional shift, soft muted lighting, turning point. {style}",
        "text_position": "split"
    },
    {
        "id": 11,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager seated at CENTER of frame, exactly ONE pet held in their lap, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, sitting in a veterinary waiting room chair at CENTER of frame, arms wrapped protectively around the pet in their lap, chin resting on top of the pet's head, worried loving expression, completely focused on the animal. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, cradled in the teenager's lap wrapped in a soft blanket, resting calmly against the teen's chest, tired eyes looking up with trust, feeling safe. TOGETHER: teen holds the pet snugly against their chest, both occupying the same chair, the backpack on the floor beside them with the phone forgotten inside. SETTING: Veterinary waiting room WIDE VIEW, plastic chairs, health posters on walls, clinical warm lighting. ATMOSPHERE: Tender worry, protective love, quiet anxiety, emotional depth. {style}",
        "text_position": "split"
    },
    {
        "id": 12,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager hugging at CENTER of frame, exactly ONE pet in their embrace, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, kneeling on the floor at CENTER of veterinary office, arms wrapped around the pet in a tight emotional embrace, eyes closed with tears of relief on cheeks, genuine deep emotion on face. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, standing calmly as the teenager wraps both arms around its neck and shoulders, eyes soft with trust, tail wagging gently, feeling the warmth of the embrace. TOGETHER: teen kneels and holds the pet in a full tearful hug of relief, cheek pressed against the pet's head. SETTING: Veterinary examination room WIDE VIEW, examination table and equipment in background, soft overhead lighting, clean clinical space. ATMOSPHERE: Overwhelming relief, deep love realized, tears of joy, emotional catharsis. {style}",
        "text_position": "split"
    },
    {
        "id": 13,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager sitting at LEFT of frame, exactly ONE pet in a nest at CENTER of frame, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, sitting cross-legged on the living room floor at LEFT of frame, one hand gently stroking the pet's head, peaceful devoted expression, no phone visible. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, lying in an elaborate nest of soft pillows and blankets at CENTER of frame, eyes half-closed in peaceful comfort, healing expression, enjoying the gentle petting. TOGETHER: teen sits beside the cozy nest petting the pet softly, phone lying forgotten face-down on the floor far behind them. SETTING: Living room floor WIDE VIEW, pillow and blanket nest, soft warm lamplight, curtains drawn, cozy evening. ATMOSPHERE: Devoted care, healing warmth, quiet peaceful devotion, golden lamplight. {style}",
        "text_position": "split"
    },
    {
        "id": 14,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager in the bed above, exactly ONE pet in a small bed below, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, lying in bed at the TOP of frame, staring at the ceiling with glistening emotional eyes, one hand hanging off the edge of the bed reaching downward, expression of deep realization. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sleeping peacefully in a pet bed on the floor BELOW the hanging hand, one paw stretched upward touching the teen's fingers, peaceful sleeping expression. TOGETHER: teen's hanging hand and pet's raised paw nearly touch in the moonlit darkness, a connection even in sleep. SETTING: Dark bedroom WIDE VIEW, moonlight through window creating soft blue-silver light, serene night atmosphere. ATMOSPHERE: Deep emotional realization, moonlit contemplation, bittersweet understanding, quiet tears, blue-silver night light. {style}",
        "text_position": "split"
    },
    {
        "id": 15,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager standing at LEFT of frame, exactly ONE pet sitting at RIGHT of frame, no extra characters, pure illustration only. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, standing energetically at the LEFT side of the bedroom doorway, big genuine smile, both arms spread wide in excitement, wearing casual outdoor clothes, one hand gesturing invitingly toward the pet. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting upright at RIGHT of frame in the hallway looking up at the teenager, head tilted to one side, ears fully perked, tail a blur from wagging so fast, eyes wide with surprised delight. TOGETHER: teen stands in the doorway framed by morning light while the pet sits facing them in joyful disbelief. SETTING: Home hallway morning WIDE VIEW, bright golden morning sunlight flooding through open front door in background, shoes by the door. ATMOSPHERE: Joyful new beginning, bright exciting morning, pure happiness, surprise and delight. {style}",
        "text_position": "split"
    },
    {
        "id": 16,
    ...
    },
    {
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager sitting at CENTER-LEFT of frame, exactly ONE pet sitting close beside them at CENTER-RIGHT, no extra characters. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, sitting cross-legged on the living room floor at CENTER-LEFT, holding old printed photos and laughing warmly, face scrunched up from a lick, happy tearful expression. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting right beside the teenager at CENTER-RIGHT, leaning in to lick the teen's cheek affectionately, tail wagging, surrounded by scattered old photos on the floor. TOGETHER: teen and pet sit close together at center frame, photos spread on the floor around them, sharing a warm emotional moment. SETTING: Living room floor WIDE VIEW, scattered old photos showing a puppy and young child, warm lamp light, cozy carpeted floor, photo box beside them. ATMOSPHERE: Warm nostalgia, deep love, happy tears, golden lamplight, beautiful emotional connection. {style}",
        "text_position": "split"
    },
    {
        "id": 18,
        ...
        "prompt": "Disney Pixar 3D style illustration. STRICT: exactly ONE teenager at LEFT of frame holding a phone as camera, exactly ONE pet sitting at RIGHT of frame posing, no extra characters, pure illustration only. HUMAN: @image1 = copy exactly @image1: {gender_word} teenager ({age_display}), teen face and proportions — match reference exactly{glasses_desc}, kneeling at LEFT of frame, holding a phone up as a camera toward the pet, big warm smile, eyes lit with genuine affection. PET: @image2 = {pet_name} ({pet_desc}): copy exactly the animal from @image2, same coat color, body size and figure — match reference exactly, sitting nicely at RIGHT of frame facing the camera, looking directly at the phone lens with bright happy eyes, tail wagging, natural adorable pose. TOGETHER: teen frames the pet in their phone camera from a few feet away, both looking at each other through the lens with joy. SETTING: Living room WIDE VIEW, warm golden hour lighting, cozy home atmosphere, colorful small sticky notes on the wall behind them. ATMOSPHERE: Warm transformation, technology used for love, golden light, heartwarming joy. {style}",
        "text_position": "split"
    },
    {
        "id": 19,
...
BACK_COVER = {
    "prompt": "Disney Pixar 3D style illustration. STRICT: only objects and scenery, no people present. SETTING: A cozy teenager's desk scene at golden hour WIDE VIEW, a phone lying on the desk with a glowing screen, a pair of headphones, scattered old printed photographs of a child and pet growing up together, a tennis ball, a soft blanket draped over the desk chair, warm sunset light streaming through a window onto the objects, a small pet bed visible in the corner, colorful small sticky notes on the wall. ATMOSPHERE: Warm nostalgic, peaceful evening, love expressed through objects, golden warm tones, story told through belongings. Pure illustration only. {style}"
}
