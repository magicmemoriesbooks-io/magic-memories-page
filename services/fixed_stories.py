    ...
    "baby_soft_world": {
        ...
        "pages": [
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Pale yellow onesie with tiny white polka dots. ACTION: Baby sitting on a soft fluffy white blanket on the floor, serene joyful expression with gentle smile, tiny hands reaching gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Only ONE baby. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Pale yellow onesie with tiny white polka dots. ACTION: Toddler standing on the nursery floor, serene joyful expression with gentle smile, small hands reaching up gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Only ONE toddler. Child is fully human."
            },
            {
                "text_es": "Escuchas voces dulces.\nSientes un abrazo.\nUn corazón cerca.\nLate contigo.",
                "text_en": "You hear sweet voices.\nYou feel a hug.\nA heart nearby.\nBeats with you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Mint green and white striped bodysuit. ACTION: Baby sitting on a soft fluffy white blanket, peaceful happy expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in lap. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Mint green and white striped bodysuit. ACTION: Toddler standing in the nursery, peaceful happy expression, hugging NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) against chest with both arms. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Tus manos descubren.\nTus ojos miran.\nPoco a poco,\naprendes el mundo.",
                "text_en": "Your hands discover.\nYour eyes look.\nLittle by little,\nyou learn the world.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Warm peach onesie with small white dots. ACTION: Baby sitting on a soft fluffy white blanket, curious wonder-filled expression, gently reaching out tiny hands toward NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) sitting on the blanket in front of baby. Magical golden sparkles appear where baby's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Warm peach onesie with small white dots. ACTION: Toddler walking across the nursery floor toward NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) sitting on the floor, small hands reaching out toward the bunny toy. Magical golden sparkles appear where the child's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Cada día es mágico.\nCada risa es música.\nCada abrazo es amor.\nCrecerás feliz.",
                "text_en": "Every day is magical.\nEvery laugh is music.\nEvery hug is love.\nYou will grow happy.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Light blue and white thin striped sleeper. ACTION: Baby sitting on a soft fluffy white blanket, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in arms. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human, baby has a gentle natural closed-mouth smile.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Light blue and white thin striped sleeper. ACTION: Toddler standing in the nursery, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in arms against chest. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human, child has a gentle natural closed-mouth smile."
            },
            {
                "text_es": "Mira cómo brillas.\nCon cada sonrisa.\nCon cada mirada.\nEres pura magia.",
                "text_en": "Look how you shine.\nWith every smile.\nWith every glance.\nYou are pure magic.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Cream onesie with tiny orange polka dots. ACTION: Baby sitting on a soft fluffy white blanket, wonder-filled eyes, gentle amazed expression, tiny hands reaching toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the blanket beside baby. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Cream onesie with tiny orange polka dots. ACTION: Toddler standing in the nursery, wonder-filled eyes, gentle amazed expression, small hands reaching up toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the floor beside the child. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Sales al jardín.\nTocas una flor.\nHueles la brisa.\nEl mundo es enorme.",
                "text_en": "You go to the garden.\nYou touch a flower.\nYou smell the breeze.\nThe world is enormous.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Soft teal and white striped snap bodysuit. ACTION: Baby sitting on soft green grass in a sunny garden, gentle curious smile, tiny hands reaching toward a bright pink flower. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside baby. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Soft teal and white striped snap bodysuit. ACTION: Toddler standing on soft green grass in a sunny garden, gentle curious smile, bending down slightly to touch a bright pink flower with small hands. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside the child. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Es hora de descansar.\nEl día fue bonito.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nThe day was beautiful.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Pale lavender onesie with tiny yellow dots. ACTION: Baby lying in a classic white wooden crib, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. NUBE, a white bunny plush toy with long floppy ears and soft pink inner lining, tiny pink nose and black button eyes, rests beside baby in the crib. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing, mobile with stars above crib. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Pale lavender onesie with tiny yellow dots. ACTION: Toddler lying in a cozy toddler bed, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. NUBE, a white bunny plush toy with long floppy ears and soft pink inner lining, tiny pink nose and black button eyes, rests beside the child in bed. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            }
        ],
    },
    "baby_puppy_love": {
        ...
        "pages": [
            {
                ...
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) toddler (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, curious loving expression, looking down at MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting calmly on the floor looking up at child. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
    ...
    "baby_guardian_light": {
        ...
        "pages": [
            ...
            },
            {
                ...
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) toddler (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Soft lavender playsuit. ACTION: Toddler jumping with both feet off the ground, arms spread wide, laughing with pure joy, while {guardian_light_desc} hovers nearby and pulses brighter, sending tiny golden hearts floating upward. SETTING: Joyful nursery WIDE VIEW, warm golden light filling the room, soft plush toys around, floating sparkles and tiny pink hearts drifting in the air. ATMOSPHERE: Pure love and happiness, light responding to child's joy. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            },
            {
