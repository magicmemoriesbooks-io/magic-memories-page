...
STORIES = {
    "baby_soft_world": {
        ...
        "age_range": "0-1",
        "preview_prompt_override": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, extremely chubby cheeks, round baby face, tiny hands, sweet innocent expression looking at the viewer. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby is sitting on a soft fluffy white blanket on the nursery floor. Next to the baby sits a small soft fluffy white bunny plush toy with long floppy ears and pink inner ears, placed separately on the blanket. ENVIRONMENT: Cozy nursery, soft pastel pink walls, gentle floating feathers and golden sparkles. ATMOSPHERE: Warm dreamy magical light, soft pastel colors, innocence and wonder. STRICT: Exactly ONE human baby, exactly ONE plush bunny toy, baby is 100% human with completely normal body, two tiny arms, two tiny legs, smooth human skin, round human ears, normal infant anatomy, bunny is a separate stuffed toy placed on the floor, clean illustration only",
        "preview_prompt_override_toddler": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, chubby cheeks, round toddler face, small hands, sweet curious expression looking at the viewer. WEARING: Plain soft white onesie. ACTION: Toddler is standing on tiny feet on a soft fluffy white blanket on the nursery floor, holding a small soft fluffy white bunny plush toy with long floppy ears and pink inner ears in one arm. ENVIRONMENT: Cozy nursery, soft pastel pink walls, gentle floating feathers and golden sparkles. ATMOSPHERE: Warm dreamy magical light, soft pastel colors, innocence and wonder. STRICT: Exactly ONE human toddler, exactly ONE plush bunny toy, toddler is 100% human with completely normal body, two arms, two legs, smooth human skin, round human ears, normal toddler anatomy, bunny is a separate stuffed toy, clean illustration only",
        ...
        "pages": [
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face, tiny hands. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby lying flat on back on a soft fluffy white blanket, tiny legs relaxed, tiny arms resting at sides, looking up with calm curious wonder. SETTING: Cozy nursery WIDE VIEW, cream crib in background, fluffy pillows and gentle floating feathers in soft pastel colors around baby, warm golden morning light through white curtains, pastel pink walls, soft plush toys on cream shelves, magical sparkles in the air. ATMOSPHERE: Warm cozy magical morning light, innocence and discovery. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face, small hands. WEARING: Plain soft white onesie. ACTION: Toddler standing on tiny feet on a soft fluffy white blanket in the nursery, looking around with calm curious wonder, small hands at sides. SETTING: Cozy nursery WIDE VIEW, cream crib in background, fluffy pillows and gentle floating feathers in soft pastel colors around child, warm golden morning light through white curtains, pastel pink walls, soft plush toys on cream shelves, magical sparkles in the air. ATMOSPHERE: Warm cozy magical morning light, innocence and discovery. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human."
            },
            {
                "text_es": "La luz brilla despacio.\nLos colores sonríen.\nEl aire es tranquilo.\nTú estás a salvo.",
                "text_en": "The light shines softly.\nColors are smiling.\nThe air is calm.\nYou are safe.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket on the floor, serene joyful expression with gentle smile, tiny hands reaching gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing on the nursery floor, serene joyful expression with gentle smile, small hands reaching up gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human."
            },
            {
                "text_es": "Escuchas voces dulces.\nSientes un abrazo.\nUn corazón cerca.\nLate contigo.",
                "text_en": "You hear sweet voices.\nYou feel a hug.\nA heart nearby.\nBeats with you.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, peaceful happy expression, holding a small soft fluffy white bunny plush toy with long floppy ears and pink inner ears in lap. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, peaceful happy expression, hugging a small soft fluffy white bunny plush toy with long floppy ears and pink inner ears against chest with both arms. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human."
            },
            {
                "text_es": "Tus manos descubren.\nTus ojos miran.\nPoco a poco,\naprendes el mundo.",
                "text_en": "Your hands discover.\nYour eyes look.\nLittle by little,\nyou learn the world.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, curious wonder-filled expression, gently reaching out tiny hands toward a small soft fluffy white bunny plush toy with long floppy ears sitting on the blanket in front of baby. Magical golden sparkles appear where baby's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler walking across the nursery floor toward a small soft fluffy white bunny plush toy with long floppy ears sitting on the floor, small hands reaching out toward the bunny toy. Magical golden sparkles appear where the child's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human."
            },
            {
                "text_es": "Cada día es mágico.\nCada risa es música.\nCada abrazo es amor.\nCrecerás feliz.",
                "text_en": "Every day is magical.\nEvery laugh is music.\nEvery hug is love.\nYou will grow happy.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding a small soft fluffy white bunny plush toy with long floppy ears in arms. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human, baby has a gentle natural closed-mouth smile.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding a small soft fluffy white bunny plush toy with long floppy ears in arms against chest. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human, child has a gentle natural closed-mouth smile."
            },
            {
                "text_es": "Mira cómo brillas.\nCon cada sonrisa.\nCon cada mirada.\nEres pura magia.",
                "text_en": "Look how you shine.\nWith every smile.\nWith every glance.\nYou are pure magic.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, wonder-filled eyes, gentle amazed expression, tiny hands reaching toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the blanket beside baby. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, wonder-filled eyes, gentle amazed expression, small hands reaching up toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the floor beside the child. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human."
            },
            {
                "text_es": "Sales al jardín.\nTocas una flor.\nHueles la brisa.\nEl mundo es enorme.",
                "text_en": "You go to the garden.\nYou touch a flower.\nYou smell the breeze.\nThe world is enormous.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft green grass in a sunny garden, gentle curious smile, tiny hands reaching toward a bright pink flower. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside baby. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing on soft green grass in a sunny garden, gentle curious smile, bending down slightly to touch a bright pink flower with small hands. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside the child. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human."
            },
            {
                "text_es": "Es hora de descansar.\nEl día fue bonito.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nThe day was beautiful.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby lying in a classic white wooden crib, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. A small soft fluffy white bunny plush toy with long floppy ears rests beside baby in the crib. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing, mobile with stars above crib. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush bunny toy, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler lying in a cozy toddler bed, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. A small soft fluffy white bunny plush toy with long floppy ears rests beside the child in bed. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush bunny toy, child is fully human."
            }
        ],
    },
    "baby_puppy_love": {
        ...
        "age_range": "0-1",
        "use_preview_as_cover": True,
        "preview_prompt_override": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, extremely chubby cheeks, round baby face, tiny hands, sweet loving expression. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby is sitting on a soft pastel blanket, hugging POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round black button eyes, small floppy ears, pink embroidered nose, sweet embroidered smile, a stuffed plush toy) against chest. ENVIRONMENT: Cozy nursery, cream crib in background, soft morning light, pastel pink walls, gentle floating sparkles. ATMOSPHERE: Warm dreamy magical golden light, soft pink hearts floating gently. STRICT: Only ONE baby, only ONE plush puppy toy POMPOM, baby is 100% human with completely normal body, two tiny arms, two tiny legs, smooth human skin, round human ears, normal infant anatomy, POMPOM is a stuffed plush toy.",
        "preview_prompt_override_toddler": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, chubby cheeks, round toddler face, small hands, sweet loving expression. WEARING: Plain soft white onesie. ACTION: Toddler is standing on tiny feet on a soft pastel blanket, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round black button eyes, small floppy ears, pink embroidered nose, sweet embroidered smile, a stuffed plush toy) in one arm against chest. ENVIRONMENT: Cozy nursery, cream crib in background, soft morning light, pastel pink walls, gentle floating sparkles. ATMOSPHERE: Warm dreamy magical golden light, soft pink hearts floating gently. STRICT: Only ONE toddler, only ONE plush puppy toy POMPOM, toddler is 100% human with completely normal body, two arms, two legs, smooth human skin, round human ears, normal toddler anatomy, POMPOM is a stuffed plush toy.",
        ...
        "pages": [
            {
                ...
                "text_en": "Hello, {name}.\nThis is your puppy.\nYour favorite puppy.\nAlways with you.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on the soft pastel nursery floor, looking with curious loving eyes at POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, pink embroidered nose, a stuffed plush toy) sitting on the floor next to baby. SETTING: Cozy nursery WIDE VIEW, cream crib, pastel pink walls, soft morning light streaming through curtains, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning light, soft golden sparkles. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, looking down with curious loving eyes at POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, pink embroidered nose, a stuffed plush toy) sitting on the floor beside child. SETTING: Cozy nursery WIDE VIEW, cream crib, pastel pink walls, soft morning light streaming through curtains, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning light, soft golden sparkles. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "El perrito mueve la cola.\nTe mira y sonríe.\nParece decir:\n\"Yo te quiero mucho\".",
                "text_en": "The puppy wags its tail.\nIt looks at you and smiles.\nIt seems to say:\n\"I love you so much\".",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, watching POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) sitting directly in front of baby. Tiny pink hearts floating between them. SETTING: Magical nursery WIDE VIEW, pastel pink and cream colors, toys on shelves, dreamy sparkles filling the space. ATMOSPHERE: Dreamy magical sparkles, soft warm light, floating pink hearts. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, looking down at POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) sitting on the floor in front of child. Tiny pink hearts floating between them. SETTING: Magical nursery WIDE VIEW, pastel pink and cream colors, toys on shelves, dreamy sparkles filling the space. ATMOSPHERE: Dreamy magical sparkles, soft warm light, floating pink hearts. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "Y tú, {name},\nlo abrazas fuerte.\nCon tu corazón dices:\n\"Yo te quiero más\".",
                "text_en": "And you, {name},\nhug it tight.\nWith your heart you say:\n\"I love you more\".",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, eyes closed with sweet contented expression, hugging POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) tightly against chest with both tiny arms, peaceful loving expression. SETTING: Cozy nursery WIDE VIEW, warm golden light bathing the room, ultra-soft pastel pink and cream colors. ATMOSPHERE: Soft sparkly hearts surrounding baby and POMPOM, warm golden glow, pure love and comfort. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, eyes closed with sweet contented expression, hugging POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) tightly against chest with both arms, peaceful loving expression. SETTING: Cozy nursery WIDE VIEW, warm golden light bathing the room, ultra-soft pastel pink and cream colors. ATMOSPHERE: Soft sparkly hearts surrounding child and POMPOM, warm golden glow, pure love and comfort. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, happy joyful expression, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) up in the air with both tiny hands, lifting the toy high with affection. SETTING: Cheerful nursery WIDE VIEW, bright pastel colors, magical sparkles everywhere, colorful hearts of different sizes floating around the room. ATMOSPHERE: Pure joy and celebration. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM held by baby, baby is fully human with smooth human skin only.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, happy joyful expression, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) up in the air with both hands, lifting the toy high with affection. SETTING: Cheerful nursery WIDE VIEW, bright pastel colors, magical sparkles everywhere, colorful hearts of different sizes floating around the room. ATMOSPHERE: Pure joy and celebration. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM held by child, child is fully human with smooth human skin only."
            },
            {
                "text_es": "¿Sabes cuánto te quiero?\nHasta la luna.\nHasta las estrellas.\nPara siempre jamás.",
                "text_en": "Do you know how much I love you?\nTo the moon.\nTo the stars.\nForever and ever.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, sweetest expression, eyes full of wonder, with POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) resting on lap, both looking up at magical floating hearts and stars that fill the room above them. SETTING: Magical nursery WIDE VIEW, dreamy pink and golden light, floating hearts in different sizes, tiny stars twinkling, magical sparkles everywhere. ATMOSPHERE: Infinite love, dreamy celestial magic, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, sweetest expression, eyes full of wonder, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) in one arm, looking up at magical floating hearts and stars that fill the room above. SETTING: Magical nursery WIDE VIEW, dreamy pink and golden light, floating hearts in different sizes, tiny stars twinkling, magical sparkles everywhere. ATMOSPHERE: Infinite love, dreamy celestial magic, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft nursery floor, joyful expression, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) with one hand while reaching for a colorful toy with the other, soft blocks and a rattle and a small ball scattered around. SETTING: Playful nursery WIDE VIEW, warm golden afternoon sunlight streaming through window, soft pink and cream nursery, toys everywhere, sunset colors visible through window. ATMOSPHERE: Warm playful golden light, gentle sparkles, cheerful afternoon energy. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler sitting on soft nursery floor, joyful expression, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) with one hand while reaching for a colorful toy with the other, soft blocks and a rattle and a small ball scattered around. SETTING: Playful nursery WIDE VIEW, warm golden afternoon sunlight streaming through window, soft pink and cream nursery, toys everywhere, sunset colors visible through window. ATMOSPHERE: Warm playful golden light, gentle sparkles, cheerful afternoon energy. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting by a nursery window at night, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, pink embroidered nose, a stuffed toy) in lap, looking at stars and moon through the window with calm wonder. SETTING: Nursery WIDE VIEW, soft night light glowing warmly, stars visible through window, gentle moonlight streaming in, magical sparkles in the air, soft lavender and cream tones. ATMOSPHERE: Peaceful nighttime transition, magical starlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing by a nursery window at night, holding POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, pink embroidered nose, a stuffed toy) in one arm, looking at stars and moon through the window with calm wonder. SETTING: Nursery WIDE VIEW, soft night light glowing warmly, stars visible through window, gentle moonlight streaming in, magical sparkles in the air, soft lavender and cream tones. ATMOSPHERE: Peaceful nighttime transition, magical starlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "Juntos descansan.\nPerrito y {name}.\nDos amigos.\nMucho, mucho amor.",
                "text_en": "Together they rest.\nPuppy and {name}.\nTwo friends.\nSo much love.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed, cuddling POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) close to chest with tiny arms. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside the window. ATMOSPHERE: Serene peaceful moonlit glow, dreamy calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM cuddled by baby, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler peacefully sleeping in a cozy toddler bed, eyes gently closed, cuddling POMPOM (a small golden plush puppy toy with soft cream-gold fur, big round button eyes, small floppy ears, a stuffed toy) close to chest with small arms. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside the window. ATMOSPHERE: Serene peaceful moonlit glow, dreamy calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM cuddled by child, child is fully human."
            }
        ],
    },
    "baby_first_pet": {
        ...
        "preview_prompt_override_toddler": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, chubby cheeks, round toddler face, small hands, sweet curious expression. WEARING: Plain soft white onesie. ACTION: Toddler is standing on tiny feet on a soft pastel blanket, looking down at MISU (a tiny baby kitten with soft fluffy ginger-orange fur with faint tabby stripes, bright curious green eyes, tiny pink nose, a real baby kitten) sitting at the child's feet, looking up curiously. ENVIRONMENT: Cozy nursery, soft pastel mint green walls, gentle sparkles floating, warm light. ATMOSPHERE: Warm dreamy magical light, soft luminous colors, gentle wonder of first meeting. STRICT: Only ONE toddler, only ONE kitten MISU, toddler is 100% human with completely normal body, two arms, two legs, smooth human skin, round human ears, normal toddler anatomy, MISU is a separate real kitten sitting at the child's feet.",
        ...
        "pages": [
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on a soft pastel nursery floor, curious loving expression, next to baby sits MISU (a tiny baby kitten with soft ginger-orange fur, bright curious green eyes, tiny pink nose, fluffy short tail) sitting calmly on the floor looking at baby. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, curious loving expression, looking down at MISU (a tiny baby kitten with soft ginger-orange fur, bright curious green eyes, tiny pink nose, fluffy short tail) sitting calmly on the floor looking up at child. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Mi gatito se acerca despacito.\nCamina con cuidado.\nMe observa curioso.",
                "text_en": "My kitten comes closer slowly.\nIt walks carefully.\nIt watches me curiously.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, watching with wonder as MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, fluffy tail raised) walks slowly and carefully toward baby, MISU's curious bright green eyes focused ahead. SETTING: Nursery WIDE VIEW, soft warm light, mint and cream colors, gentle floating sparkles. ATMOSPHERE: Gentle curiosity, tender approach, magical sparkles. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, watching with wonder as MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, fluffy tail raised) walks slowly and carefully toward child, MISU's curious bright green eyes focused ahead. SETTING: Nursery WIDE VIEW, soft warm light, mint and cream colors, gentle floating sparkles. ATMOSPHERE: Gentle curiosity, tender approach, magical sparkles. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Yo miro al gatito.\nEl gatito me mira.\n{name} sonríe.",
                "text_en": "I look at the kitten.\nThe kitten looks at me.\n{name} smiles.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle happy expression. Baby and MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, tiny pink nose) looking at each other warmly. MISU sits in front of baby with curious tilted head, bright green eyes meeting baby's gaze. SETTING: Loving nursery WIDE VIEW, warm golden light streaming in, soft pastel colors, magical sparkles around them. ATMOSPHERE: Sweet connection, first eye contact, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler crouching on the nursery floor, gentle happy expression. Child and MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, tiny pink nose) looking at each other at eye level warmly. MISU sits in front of child with curious tilted head. SETTING: Loving nursery WIDE VIEW, warm golden light streaming in, soft pastel colors, magical sparkles around them. ATMOSPHERE: Sweet connection, first eye contact, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Toco al gatito con mi mano.\nSu pelito es blandito.\nMe gusta sentirlo.",
                "text_en": "I touch the kitten with my hand.\nIts fur is so soft.\nI like how it feels.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, sweet curious expression, gently reaching out with tiny baby hand to pet MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes). MISU sits still, eyes closed contentedly, enjoying the gentle touch. SETTING: Nursery WIDE VIEW, warm soft lighting, mint green and cream tones, gentle sparkles. ATMOSPHERE: Tender moment of first touch, warm gentle magic. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler crouching down in the nursery, sweet curious expression, gently reaching out with small hand to pet MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes). MISU sits still, eyes closed contentedly, enjoying the gentle touch. SETTING: Nursery WIDE VIEW, warm soft lighting, mint green and cream tones, gentle sparkles. ATMOSPHERE: Tender moment of first touch, warm gentle magic. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "El gatito salta y juega.\nHace cosas divertidas.\n{name} ríe feliz.",
                "text_en": "The kitten jumps and plays.\nIt does funny things.\n{name} laughs happily.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft nursery floor, joyful expression, watching MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, fluffy short tail) playing and jumping, chasing a small yarn ball. MISU is mid-leap with fluffy tail excited. SETTING: Playful nursery WIDE VIEW, bright cheerful afternoon light, colorful toys scattered around, magical sparkles everywhere, warm golden sunset colors visible through window. ATMOSPHERE: Pure joy and playfulness, cheerful energy, warm sunset glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human with smooth human skin only.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, joyful expression, watching MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes, fluffy short tail) playing and jumping, chasing a small yarn ball. MISU is mid-leap with fluffy tail excited. SETTING: Playful nursery WIDE VIEW, bright cheerful afternoon light, colorful toys scattered around, magical sparkles everywhere, warm golden sunset colors visible through window. ATMOSPHERE: Pure joy and playfulness, cheerful energy, warm sunset glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human with smooth human skin only."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle smile, baby's tiny hand gently resting on MISU's back. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) curled up as a ball next to baby, resting contentedly. SETTING: Cozy nursery WIDE VIEW, warm golden afternoon light streaming through window, peaceful calm atmosphere, mint green and cream tones, soft plush toys nearby. ATMOSPHERE: Tender bonding moment, warm afternoon glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler sitting on the nursery floor on a soft blanket, gentle smile, small hand gently resting on MISU's back. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) curled up as a ball next to child, resting contentedly. SETTING: Cozy nursery WIDE VIEW, warm golden afternoon light streaming through window, peaceful calm atmosphere, mint green and cream tones, soft plush toys nearby. ATMOSPHERE: Tender bonding moment, warm afternoon glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU curled up next to child, child is fully human."
            },
            {
                "text_es": "La luna sale en el cielo.\nTodo se vuelve tranquilo.\nMISU bosteza despacito.\nYa casi es hora de dormir.",
                "text_en": "The moon rises in the sky.\nEverything becomes quiet.\nMISU yawns softly.\nIt's almost time to sleep.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting by a nursery window at night, watching MISU and the moonlight with calm wonder. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) sitting on the windowsill looking at the moon. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, stars visible in the night sky, soft lavender and cream tones, gentle sparkles in the air. ATMOSPHERE: Peaceful nighttime transition, magical moonlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU on windowsill, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing by a nursery window at night, watching MISU and the moonlight with calm wonder. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) sitting on the windowsill looking at the moon. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, stars visible in the night sky, soft lavender and cream tones, gentle sparkles in the air. ATMOSPHERE: Peaceful nighttime transition, magical moonlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU on windowsill, child is fully human."
            },
            {
                "text_es": "Es hora de descansar.\nMISU se acurruca conmigo.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nMISU snuggles close to me.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) curled up sleeping next to baby, both resting on a cloud-soft blanket. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside. ATMOSPHERE: Serene peaceful moonlit calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler peacefully sleeping in a cozy toddler bed, eyes gently closed. MISU (a tiny baby kitten with soft ginger-orange fur, bright green eyes) curled up sleeping next to child, both resting on a cloud-soft blanket. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside. ATMOSPHERE: Serene peaceful moonlit calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU curled up next to child, child is fully human."
            }
        ],
    },
    "baby_guardian_light": {
        ...
        "age_range": "0-1",
        "use_preview_as_cover": True,
        "preview_prompt_override": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, extremely chubby cheeks, round baby face, tiny hands, innocent sweet expression. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby is sitting on a soft pastel blanket with a tiny smooth plain round glowing ball of pure warm golden light with gentle rays floating gently nearby, casting a warm soft protective glow toward the baby. Soft toys visible in background. ENVIRONMENT: Cozy nursery, soft pastel lavender and cream walls, gentle sparkles floating. ATMOSPHERE: Warm dreamy magical golden light, love and protection, soft luminous colors. STRICT: Only ONE baby, baby is 100% human with completely normal body, two tiny arms, two tiny legs, smooth human skin, round human ears, normal infant anatomy, baby wearing white onesie, glowing orb is a featureless plain sphere of light only.",
        "preview_prompt_override_toddler": "Disney 3D Pixar-style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_desc}, chubby cheeks, round toddler face, small hands, innocent curious expression. WEARING: Plain soft white onesie. ACTION: Toddler is standing on tiny feet on a soft pastel blanket, looking up with wonder at a tiny smooth plain round glowing ball of pure warm golden light with gentle rays floating gently above, casting a warm soft protective glow toward the child. Soft toys visible in background. ENVIRONMENT: Cozy nursery, soft pastel lavender and cream walls, gentle sparkles floating. ATMOSPHERE: Warm dreamy magical golden light, love and protection, soft luminous colors. STRICT: Only ONE toddler, toddler is 100% human with completely normal body, two arms, two legs, smooth human skin, round human ears, normal toddler anatomy, glowing orb is a featureless plain sphere of light only.",
        ...
        "pages": [
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on a soft pastel nursery floor, looking up with wonder as a tiny smooth plain round glowing ball of pure warm golden light with gentle rays appears floating gently in the room, casting a warm soft glow. Soft plush toys scattered nearby. SETTING: Cozy nursery WIDE VIEW, soft evening light, lavender and cream walls, cream-colored furniture, gentle sparkles emanating from the glowing orb. ATMOSPHERE: Warm magical love and protection, soft golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a featureless plain sphere of warm light only.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, looking up with wonder as a tiny smooth plain round glowing ball of pure warm golden light with gentle rays appears floating gently in the room, casting a warm soft glow. Soft plush toys scattered nearby. SETTING: Cozy nursery WIDE VIEW, soft evening light, lavender and cream walls, cream-colored furniture, gentle sparkles emanating from the glowing orb. ATMOSPHERE: Warm magical love and protection, soft golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a featureless plain sphere of warm light only."
            },
            {
                "text_es": "La luz se mueve despacio.\nNo hace ruido.\nTodo es calma.",
                "text_en": "The light moves slowly.\nIt makes no sound.\nAll is calm.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, watching peacefully as a tiny smooth plain round glowing ball of pure warm golden light floats slowly and gracefully through the room, leaving a soft trail of golden sparkles behind. SETTING: Peaceful nursery WIDE VIEW, serene atmosphere, soft lavender and cream tones, plush toys on floor, everything bathed in gentle warm glow. ATMOSPHERE: Tranquil magical calm, serene golden warmth. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, watching peacefully as a tiny smooth plain round glowing ball of pure warm golden light floats slowly and gracefully through the room, leaving a soft trail of golden sparkles behind. SETTING: Peaceful nursery WIDE VIEW, serene atmosphere, soft lavender and cream tones, plush toys on floor, everything bathed in gentle warm glow. ATMOSPHERE: Tranquil magical calm, serene golden warmth. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, joyful happy expression, while a tiny smooth plain round glowing ball of pure warm golden light floats nearby, glowing brighter with warmth, pulsing gently as if responding to baby's joy. SETTING: Joyful nursery WIDE VIEW, warm golden light filling the room, soft toys around, floating hearts and sparkles. ATMOSPHERE: Pure love and happiness, responsive magical glow. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, joyful happy expression, while a tiny smooth plain round glowing ball of pure warm golden light floats nearby, glowing brighter with warmth, pulsing gently as if responding to child's joy. SETTING: Joyful nursery WIDE VIEW, warm golden light filling the room, soft toys around, floating hearts and sparkles. ATMOSPHERE: Pure love and happiness, responsive magical glow. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            },
            {
                "text_es": "La luz mira a {name}.\nTe cuida mientras juegas.\nSiempre está cerca.",
                "text_en": "The light watches {name}.\nIt cares for you while you play.\nIt's always near.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft nursery floor, playful expression, playing with soft colorful toys, while a tiny smooth plain round glowing ball of pure warm golden light floats protectively nearby, casting a warm protective glow over baby. SETTING: Playful nursery WIDE VIEW, cheerful afternoon light, pastel colors, various plush toys scattered, magical sparkles around the glowing orb, warm golden sunlight through window. ATMOSPHERE: Sweet protective warmth, playful guardian energy. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of warm light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, playful expression, reaching toward soft colorful toys, while a tiny smooth plain round glowing ball of pure warm golden light floats protectively nearby, casting a warm protective glow over child. SETTING: Playful nursery WIDE VIEW, cheerful afternoon light, pastel colors, various plush toys scattered, magical sparkles around the glowing orb, warm golden sunlight through window. ATMOSPHERE: Sweet protective warmth, playful guardian energy. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of warm light."
            },
            {
                "text_es": "Esa luz cuida y protege.\nTodo está bien.\nNada te falta.",
                "text_en": "That light cares and protects.\nAll is well.\nYou need nothing more.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting contentedly on a soft blanket, peaceful serene expression, with a tiny smooth plain round glowing ball of pure warm golden light nearby creating a soft warm halo of protection around baby, the orb glowing steadily and emanating peace and security. SETTING: Protected nursery WIDE VIEW, soft warm light, lavender and gold tones, floating sparkles forming a gentle protective circle around baby. ATMOSPHERE: Serene complete safety and love, warm protective halo. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing contentedly in the nursery, peaceful serene expression, with a tiny smooth plain round glowing ball of pure warm golden light nearby creating a soft warm halo of protection around child, the orb glowing steadily and emanating peace and security. SETTING: Protected nursery WIDE VIEW, soft warm light, lavender and gold tones, floating sparkles forming a gentle protective circle around child. ATMOSPHERE: Serene complete safety and love, warm protective halo. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            },
            {
                ...
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket by a nursery window at night, gentle expression with lips softly closed, looking up at the night sky with soft wonder. A tiny smooth plain round glowing ball of pure warm golden light floats outside the window among stars, dancing gracefully and creating trails of golden sparkles. SETTING: Magical night sky visible through window WIDE VIEW, stars twinkling, golden trails of light, soft lavender and cream nursery tones. ATMOSPHERE: Magical starlight dance, wonder and love. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, baby has a gentle closed-mouth expression, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler standing by a nursery window at night, gentle expression with lips softly closed, looking up at the night sky with soft wonder. A tiny smooth plain round glowing ball of pure warm golden light floats outside the window among stars, dancing gracefully and creating trails of golden sparkles. SETTING: Magical night sky visible through window WIDE VIEW, stars twinkling, golden trails of light, soft lavender and cream nursery tones. ATMOSPHERE: Magical starlight dance, wonder and love. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, child has a gentle closed-mouth expression, glowing orb is a plain smooth sphere of light."
            },
            {
                "text_es": "La luz se acerca despacio.\nSe posa a tu lado.\nSuave, tranquila.\nYa casi es hora de dormir.",
                "text_en": "The light comes closer slowly.\nIt settles beside you.\nSoft and calm.\nIt's almost time to sleep.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, peaceful serene expression, while a tiny smooth plain round glowing ball of pure warm golden light floats very close beside baby at eye level, glowing gently dimmer like a soft nightlight. SETTING: Peaceful nursery WIDE VIEW, soft evening light dimming, lavender and cream tones, calm atmosphere, gentle sparkles. ATMOSPHERE: Peaceful nighttime transition, gentle calming glow. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler sitting on the edge of a toddler bed, peaceful serene expression, while a tiny smooth plain round glowing ball of pure warm golden light floats very close beside child at eye level, glowing gently dimmer like a soft nightlight. SETTING: Peaceful nursery WIDE VIEW, soft evening light dimming, lavender and cream tones, calm atmosphere, gentle sparkles. ATMOSPHERE: Peaceful nighttime transition, gentle calming glow. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            },
            {
                "text_es": "Es hora de descansar.\nLa luz cuida tu sueño.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nThe light watches over your dreams.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, extremely chubby cheeks, round baby face. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed, covered with cloud-soft blanket. A tiny smooth plain round glowing ball of pure warm golden light floats softly beside baby like a gentle nightlight, glowing with warmth and love. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight through window, soft lavender and cream tones, tiny stars twinkling outside, the glowing orb casting a warm protective glow. ATMOSPHERE: Serene eternal love and protection, moonlit dreamtime. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
                "scene_template_toddler": "Disney 3D Pixar-style illustration. CHARACTER: {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, chubby cheeks, round toddler face. WEARING: Plain soft white onesie. ACTION: Toddler peacefully sleeping in a cozy toddler bed, eyes gently closed, covered with cloud-soft blanket. A tiny smooth plain round glowing ball of pure warm golden light floats softly beside child like a gentle nightlight, glowing with warmth and love. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight through window, soft lavender and cream tones, tiny stars twinkling outside, the glowing orb casting a warm protective glow. ATMOSPHERE: Serene eternal love and protection, moonlit dreamtime. STRICT: Maintain same face and features as reference. Only ONE toddler, child is fully human, glowing orb is a plain smooth sphere of light."
            }
        ],
    },
    "dragon_friend": {
...
def get_hair_action(traits: dict) -> str:
    ...
    if length == 'very_little':
        vla_type_map = {'straight': 'straight', 'wavy': 'slightly wavy', 'curly': 'softly curly', 'afro': 'tightly coiled afro'}
        vla_t = vla_type_map.get(hair_type, 'straight')
        return "completely bald smooth head, no hair whatsoever, perfectly round smooth scalp"
    elif length == 'short':
        gender = traits.get('gender', traits.get('child_gender', ''))
        if gender == 'male':
...
def adapt_baby_pose_for_age(prompt: str, child_age: int) -> str:
    ...
    """
    if child_age == 0:
        prompt += " AGE GUIDANCE: This is a 0-12 month old baby. Keep baby lying down, sitting supported, or crawling on belly. A very young baby in a natural infant position."
    return prompt
