        ...
        "pages": [
            {
                ...
                "text_en": "Hello, {name}.\nThis is your puppy.\nYour favorite puppy.\nAlways with you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME baby from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on the soft pastel nursery floor, looking with curious loving eyes at POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) sitting on the floor next to baby. SETTING: Cozy nursery WIDE VIEW, cream crib, pastel pink walls, soft morning light streaming through curtains, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning light, soft golden sparkles. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
        ...
        "pages": [
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME baby from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on a soft pastel nursery floor, curious loving expression, next to baby sits MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting calmly on the floor looking at baby. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME baby from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle happy expression. Baby and MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) looking at each other warmly. MISU sits in front of baby with curious tilted head, bright green eyes meeting baby's gaze. SETTING: Loving nursery WIDE VIEW, warm golden light streaming in, soft pastel colors, magical sparkles around them. ATMOSPHERE: Sweet connection, first eye contact, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME baby from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle smile, baby's tiny hand gently resting on MISU's back. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up as a ball next to baby, resting contentedly. SETTING: Cozy nursery WIDE VIEW, warm golden afternoon light streaming through window, peaceful calm atmosphere, soft warm cream tones, soft plush toys nearby. ATMOSPHERE: Tender bonding moment, warm golden afternoon glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME baby from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up sleeping next to baby, both resting on a cloud-soft blanket. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside. ATMOSPHERE: Serene peaceful moonlit calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
