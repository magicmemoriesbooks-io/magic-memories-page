...
PUPPY_DESC = "POMPOM: a single small golden plush puppy toy with soft cream-gold fur, big round black button eyes, small floppy ears, black embroidered nose, sweet embroidered smile - POMPOM is a STUFFED TOY not a real dog, soft and plush like a teddy bear"
KITTEN_DESC = "MISU: a tiny baby kitten with soft ginger-orange fur and faint tabby stripes, bright curious green eyes, tiny pink nose - MISU is a REAL baby kitten, adorable and playful"
LILA_DESC = "LILA: an adult female zebra TALLER than the {gender_word}, bold black and white stripes, striped upright mane, soft light pink muzzle, sturdy black hooves, large warm brown eyes with long lashes, her back at the {gender_word}'s shoulder height, head towering above. LILA is a REAL four-legged adult zebra"
...
BUNNY_DESC = "NUBE: a small white bunny plush toy with long floppy ears, pink inner ears, tiny pink nose, gentle black button eyes - NUBE is a STUFFED TOY not a real rabbit, soft and plush"
...
GUARDIAN_LIGHT_DESC = "a tiny smooth featureless sphere of pure warm golden light, a plain round glowing ball with gentle rays floating gracefully in the air, emanating love and protection, purely an orb of luminous warmth, a simple glowing sphere of light"
...
BABY_MASTER_PROMPT = (
    "{hair_mandate} "
    "Soft luxury digital illustration, fine art children's book style, premium baby memory book. "
    "CHARACTER: {gender_face_desc} ({age_display}). "
    "{hair_desc} "
    "{eye_desc}, {skin_desc}. "
    "WEARING: {clothing_desc}. "
    "ACTION: {pose_desc} {companion_action}. "
    "ENVIRONMENT: {env_desc}. "
    "ATMOSPHERE: {atm_desc}. "
    "STRICT: {hair_strict} {anatomy_strict} {companion_strict}"
)
...
STORIES = {
    "baby_soft_world": {
        ...
        "age_range": "0-1",
        "companion_action": "NUBE, a white bunny plush toy with long floppy ears and soft pink inner lining, sits beside the baby.",
        "env_desc": "Cozy nursery, soft pastel pink walls, gentle floating feathers and golden sparkles",
        "atm_desc": "Warm dreamy magical light, soft pastel colors, innocence and wonder",
        "companion_strict": "One NUBE bunny plush. One human baby only.",
        "cover_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose, gentle closed-mouth smile, looking up with wonder. WEARING: Plain soft white onesie. ACTION: Baby is lying peacefully on a fluffy cloud-like white blanket, looking up. ENVIRONMENT: Dreamy pink and lavender background with soft clouds, gentle soap bubbles and soft pastel flower petals floating in the air, golden sparkles. ATMOSPHERE: Magical book cover composition centered, ultra soft textures, warm golden light. STRICT: Exactly ONE human baby alone in frame, baby is fully human with human ears only, soft dreamy background only.",
        "use_preview_as_cover": True,
        "pages": [
            {
                "text_es": "Hola, {name}.\nEl mundo te espera.\nTodo es nuevo.\nTodo es suave.",
                "text_en": "Hello, {name}.\nThe world awaits you.\nEverything is new.\nEverything is soft.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby lying flat on back on a soft fluffy white blanket, tiny legs relaxed, tiny arms resting at sides, looking up with calm curious wonder. SETTING: Cozy nursery WIDE VIEW, cream crib in background, fluffy pillows and gentle floating feathers in soft pastel colors around baby, warm golden morning light through white curtains, pastel pink walls, soft plush toys on cream shelves, magical sparkles in the air. ATMOSPHERE: Warm cozy magical morning light, innocence and discovery. STRICT: Only ONE baby. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing on tiny feet on a soft fluffy white blanket in the nursery, looking around with calm curious wonder, small hands at sides. SETTING: Cozy nursery WIDE VIEW, cream crib in background, fluffy pillows and gentle floating feathers in soft pastel colors around child, warm golden morning light through white curtains, pastel pink walls, soft plush toys on cream shelves, magical sparkles in the air. ATMOSPHERE: Warm cozy magical morning light, innocence and discovery. STRICT: Only ONE toddler. Child is fully human."
            },
            {
                "text_es": "La luz brilla despacio.\nLos colores sonríen.\nEl aire es tranquilo.\nTú estás a salvo.",
                "text_en": "The light shines softly.\nColors are smiling.\nThe air is calm.\nYou are safe.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket on the floor, serene joyful expression with gentle smile, tiny hands reaching gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Only ONE baby. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing on the nursery floor, serene joyful expression with gentle smile, small hands reaching up gently toward gentle pastel ribbons in pink, lavender, mint and peach that float and dance softly in the air. SETTING: Magical nursery WIDE VIEW, cream furniture, mobile hanging from ceiling, soft morning light streaming in. ATMOSPHERE: Serene calm safety, soft floating colors, magical warmth. STRICT: Only ONE toddler. Child is fully human."
            },
            {
                "text_es": "Escuchas voces dulces.\nSientes un abrazo.\nUn corazón cerca.\nLate contigo.",
                "text_en": "You hear sweet voices.\nYou feel a hug.\nA heart nearby.\nBeats with you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, peaceful happy expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in lap. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, peaceful happy expression, hugging NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) against chest with both arms. Soft glowing pink hearts and gentle golden musical notes float in the air around them. SETTING: Loving nursery WIDE VIEW, warm golden light through white curtains, soft pink and gold tones, cream crib in background. ATMOSPHERE: Pure love, warm heartbeats, gentle musical magic. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Tus manos descubren.\nTus ojos miran.\nPoco a poco,\naprendes el mundo.",
                "text_en": "Your hands discover.\nYour eyes look.\nLittle by little,\nyou learn the world.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, curious wonder-filled expression, gently reaching out tiny hands toward NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) sitting on the blanket in front of baby. Magical golden sparkles appear where baby's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler walking across the nursery floor toward NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) sitting on the floor, small hands reaching out toward the bunny toy. Magical golden sparkles appear where the child's fingers reach. SETTING: Cozy nursery WIDE VIEW, bright cheerful pastel colors, cream crib in background, soft morning light, pastel pink walls. ATMOSPHERE: Discovery and wonder, magical sparkles of first touch. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Cada día es mágico.\nCada risa es música.\nCada abrazo es amor.\nCrecerás feliz.",
                "text_en": "Every day is magical.\nEvery laugh is music.\nEvery hug is love.\nYou will grow happy.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in arms. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human, baby has a gentle natural closed-mouth smile.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, gentle warm natural closed-mouth smile, lips softly together, happy content expression, holding NUBE (white bunny plush toy, long floppy ears with soft pink inner lining, tiny pink nose, black button eyes) in arms against chest. Colorful soap bubbles and magical sparkles float all around them. SETTING: Joyful nursery WIDE VIEW, warm golden sunlight through window, pastel pink walls with soft cloud decorations, cream furniture, floating hearts and stars. ATMOSPHERE: Pure joy and magic, celebration of life, warm golden glow. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human, child has a gentle natural closed-mouth smile."
            },
            {
                "text_es": "Mira cómo brillas.\nCon cada sonrisa.\nCon cada mirada.\nEres pura magia.",
                "text_en": "Look how you shine.\nWith every smile.\nWith every glance.\nYou are pure magic.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft fluffy white blanket, wonder-filled eyes, gentle amazed expression, tiny hands reaching toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the blanket beside baby. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, wonder-filled eyes, gentle amazed expression, small hands reaching up toward floating magical butterflies made of soft light. A small soft fluffy white bunny plush toy with long floppy ears sits on the floor beside the child. SETTING: Enchanted nursery WIDE VIEW, rainbow light through window creating soft prisms, pastel pink walls, magical butterflies and sparkles in the air, cream furniture. ATMOSPHERE: Pure magic and wonder, rainbow prisms, ethereal butterflies. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Sales al jardín.\nTocas una flor.\nHueles la brisa.\nEl mundo es enorme.",
                "text_en": "You go to the garden.\nYou touch a flower.\nYou smell the breeze.\nThe world is enormous.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft green grass in a sunny garden, gentle curious smile, tiny hands reaching toward a bright pink flower. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside baby. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler standing on soft green grass in a sunny garden, gentle curious smile, bending down slightly to touch a bright pink flower with small hands. A small soft fluffy white bunny plush toy with long floppy ears sits on the grass beside the child. SETTING: Lush garden WIDE VIEW, colorful flowers blooming around, butterflies gently floating, blue sky with fluffy white clouds, warm golden sunlight, green leaves and soft petals in the air. ATMOSPHERE: Discovery of nature, wonder and innocence, warm outdoor light. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            },
            {
                "text_es": "Es hora de descansar.\nEl día fue bonito.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nThe day was beautiful.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby lying in a classic white wooden crib, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. NUBE, a white bunny plush toy with long floppy ears and soft pink inner lining, tiny pink nose and black button eyes, rests beside baby in the crib. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing, mobile with stars above crib. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Only ONE baby, only ONE NUBE plush bunny. Baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Toddler lying in a cozy toddler bed, eyes completely closed in deep peaceful sleep, covered with cream-colored soft blankets. NUBE, a white bunny plush toy with long floppy ears and soft pink inner lining, tiny pink nose and black button eyes, rests beside the child in bed. SETTING: Peaceful bedtime nursery WIDE VIEW, gentle silver moonlight through white curtains, soft lavender and cream tones, tiny stars twinkling outside window, soft night light glowing. ATMOSPHERE: Serene peaceful moonlit calm, dreamy bedtime. STRICT: Only ONE toddler, only ONE NUBE plush bunny. Child is fully human."
            }
        ],
    },
    "baby_puppy_love": {
        ...
        "age_range": "0-1",
        "use_preview_as_cover": True,
        "companion_action": "POMPOM, a golden plush puppy with floppy ears, held close to the baby's chest.",
        "env_desc": "Cozy nursery, cream crib in background, soft morning light, pastel pink walls, gentle floating sparkles",
        "atm_desc": "Warm dreamy magical golden light, soft pink hearts floating gently",
        "companion_strict": "One POMPOM puppy plush. One human baby only.",
        "cover_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Baby is sitting on a soft pastel blanket, hugging {puppy_desc} against chest with sweet loving expression. ENVIRONMENT: Dreamy soft pink, lavender and cream background, no specific room. ATMOSPHERE: Warm golden sparkles, soft floating hearts, magical book cover composition centered. STRICT: Only ONE baby, only ONE plush puppy POMPOM, no duplicates, baby is 100% human, no animal features.",
        "pages": [
            {
                "text_es": "Hola, {name}.\nEste es tu perrito.\nTu perrito favorito.\nSiempre está contigo.",
                "text_en": "Hello, {name}.\nThis is your puppy.\nYour favorite puppy.\nAlways with you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on the soft pastel nursery floor, looking with curious loving eyes at POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) sitting on the floor next to baby. SETTING: Cozy nursery WIDE VIEW, cream crib, pastel pink walls, soft morning light streaming through curtains, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning light, soft golden sparkles. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, looking down with curious loving eyes at POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) sitting on the floor beside child. SETTING: Cozy nursery WIDE VIEW, cream crib, pastel pink walls, soft morning light streaming through curtains, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning light, soft golden sparkles. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "El perrito mueve la cola.\nTe mira y sonríe.\nParece decir:\n\"Yo te quiero mucho\".",
                "text_en": "The puppy wags its tail.\nIt looks at you and smiles.\nIt seems to say:\n\"I love you so much\".",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, watching POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) sitting directly in front of baby. Tiny pink hearts floating between them. SETTING: Magical nursery WIDE VIEW, pastel pink and cream colors, toys on shelves, dreamy sparkles filling the space. ATMOSPHERE: Dreamy magical sparkles, soft warm light, floating pink hearts. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, looking down at POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) sitting on the floor in front of child. Tiny pink hearts floating between them. SETTING: Magical nursery WIDE VIEW, pastel pink and cream colors, toys on shelves, dreamy sparkles filling the space. ATMOSPHERE: Dreamy magical sparkles, soft warm light, floating pink hearts. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "Y tú, {name},\nlo abrazas fuerte.\nCon tu corazón dices:\n\"Yo te quiero más\".",
                "text_en": "And you, {name},\nhug it tight.\nWith your heart you say:\n\"I love you more\".",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, eyes closed with sweet contented expression, hugging POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) tightly against chest with both tiny arms, peaceful loving expression. SETTING: Cozy nursery WIDE VIEW, warm golden light bathing the room, ultra-soft pastel pink and cream colors. ATMOSPHERE: Soft sparkly hearts surrounding baby and POMPOM, warm golden glow, pure love and comfort. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, eyes closed with sweet contented expression, hugging POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) tightly against chest with both arms, peaceful loving expression. SETTING: Cozy nursery WIDE VIEW, warm golden light bathing the room, ultra-soft pastel pink and cream colors. ATMOSPHERE: Soft sparkly hearts surrounding child and POMPOM, warm golden glow, pure love and comfort. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, happy joyful expression, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) up in the air with both tiny hands, lifting the toy high with affection. SETTING: Cheerful nursery WIDE VIEW, bright pastel colors, magical sparkles everywhere, colorful hearts of different sizes floating around the room. ATMOSPHERE: Pure joy and celebration. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM held by baby, baby is fully human with smooth human skin only.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, happy joyful expression, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) up in the air with both hands, lifting the toy high with affection. SETTING: Cheerful nursery WIDE VIEW, bright pastel colors, magical sparkles everywhere, colorful hearts of different sizes floating around the room. ATMOSPHERE: Pure joy and celebration. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM held by child, child is fully human with smooth human skin only."
            },
            {
                "text_es": "¿Sabes cuánto te quiero?\nHasta la luna.\nHasta las estrellas.\nPara siempre jamás.",
                "text_en": "Do you know how much I love you?\nTo the moon.\nTo the stars.\nForever and ever.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, sweetest expression, eyes full of wonder, with POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) resting on lap, both looking up at magical floating hearts and stars that fill the room above them. SETTING: Magical nursery WIDE VIEW, dreamy pink and golden light, floating hearts in different sizes, tiny stars twinkling, magical sparkles everywhere. ATMOSPHERE: Infinite love, dreamy celestial magic, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, sweetest expression, eyes full of wonder, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) in one arm, looking up at magical floating hearts and stars that fill the room above. SETTING: Magical nursery WIDE VIEW, dreamy pink and golden light, floating hearts in different sizes, tiny stars twinkling, magical sparkles everywhere. ATMOSPHERE: Infinite love, dreamy celestial magic, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft nursery floor, joyful expression, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) with one hand while reaching for a colorful toy with the other, soft blocks and a rattle and a small ball scattered around. SETTING: Playful nursery WIDE VIEW, warm golden afternoon sunlight streaming through window, soft pink and cream nursery, toys everywhere, sunset colors visible through window. ATMOSPHERE: Warm playful golden light, gentle sparkles, cheerful afternoon energy. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler sitting on soft nursery floor, joyful expression, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) with one hand while reaching for a colorful toy with the other, soft blocks and a rattle and a small ball scattered around. SETTING: Playful nursery WIDE VIEW, warm golden afternoon sunlight streaming through window, soft pink and cream nursery, toys everywhere, sunset colors visible through window. ATMOSPHERE: Warm playful golden light, gentle sparkles, cheerful afternoon energy. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting by a nursery window at night, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) in lap, looking at stars and moon through the window with calm wonder. SETTING: Nursery WIDE VIEW, soft night light glowing warmly, stars visible through window, gentle moonlight streaming in, magical sparkles in the air, soft lavender and cream tones. ATMOSPHERE: Peaceful nighttime transition, magical starlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing by a nursery window at night, holding POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) in one arm, looking at stars and moon through the window with calm wonder. SETTING: Nursery WIDE VIEW, soft night light glowing warmly, stars visible through window, gentle moonlight streaming in, magical sparkles in the air, soft lavender and cream tones. ATMOSPHERE: Peaceful nighttime transition, magical starlight, calm wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM, child is fully human."
            },
            {
                "text_es": "Juntos descansan.\nPerrito y {name}.\nDos amigos.\nMucho, mucho amor.",
                "text_en": "Together they rest.\nPuppy and {name}.\nTwo friends.\nSo much love.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed, cuddling POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) close to chest with tiny arms. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside the window. ATMOSPHERE: Serene peaceful moonlit glow, dreamy calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE plush puppy POMPOM cuddled by baby, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler peacefully sleeping in a cozy toddler bed, eyes gently closed, cuddling POMPOM (golden plush puppy toy, soft floppy ears, tiny black embroidered nose, black button eyes) close to chest with small arms. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside the window. ATMOSPHERE: Serene peaceful moonlit glow, dreamy calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE plush puppy POMPOM cuddled by child, child is fully human."
            }
        ],
    },
    "baby_first_pet": {
        ...
        "age_range": "0-1",
        "use_preview_as_cover": True,
        "companion_action": "MISU, a tiny ginger-orange tabby kitten, sits beside the baby looking up.",
        "env_desc": "Cozy nursery, soft pastel mint green walls, gentle sparkles floating, warm light",
        "atm_desc": "Warm dreamy magical light, soft luminous colors, gentle wonder of first meeting",
        "companion_strict": "One MISU kitten. One human baby only.",
        "reference_image": "static/assets/kitten_reference.png",
        "cover_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate infant features, natural infant proportions, large smooth forehead, small delicate ears, tiny rounded nose, sweet innocent expression. WEARING: Plain soft white onesie. ACTION: Baby is sitting on a soft pastel blanket with {kitten_desc} sitting next to the baby, MISU looking up at the baby with curious eyes. ENVIRONMENT: Dreamy soft warm cream and golden pastel background, gentle golden sparkles, warm golden light. ATMOSPHERE: Magical book cover composition centered, ultra soft textures, warm golden light. STRICT: Only ONE baby, only ONE kitten MISU, no duplicates, baby is 100% human, no animal features, baby wearing WHITE onesie.",
        "pages": [
            {
                "text_es": "Este es mi gatito.\nEs suave y tranquilo.\nEstá cerca de mí.",
                "text_en": "This is my kitten.\nIt's soft and calm.\nIt's close to me.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie with diaper visible. ACTION: Baby sitting on a soft pastel nursery floor, curious loving expression, next to baby sits MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting calmly on the floor looking at baby. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing on the soft pastel nursery floor, curious loving expression, looking down at MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting calmly on the floor looking up at child. SETTING: Cozy nursery WIDE VIEW, soft morning light streaming through curtains, mint green and cream walls, cream-colored furniture, gentle floating sparkles. ATMOSPHERE: Warm cozy magical morning, first meeting wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Mi gatito se acerca despacito.\nCamina con cuidado.\nMe observa curioso.",
                "text_en": "My kitten comes closer slowly.\nIt walks carefully.\nIt watches me curiously.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, watching with wonder as MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) walks slowly and carefully toward baby, MISU's curious bright green eyes focused ahead. SETTING: Nursery WIDE VIEW, warm golden soft light, soft warm cream tones, gentle golden sparkles floating. ATMOSPHERE: Gentle curiosity, tender approach, warm golden magical sparkles. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, watching with wonder as MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) walks slowly and carefully toward child, MISU's curious bright green eyes focused ahead. SETTING: Nursery WIDE VIEW, warm golden soft light, soft warm cream tones, gentle golden sparkles floating. ATMOSPHERE: Gentle curiosity, tender approach, warm golden magical sparkles. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Yo miro al gatito.\nEl gatito me mira.\n{name} sonríe.",
                "text_en": "I look at the kitten.\nThe kitten looks at me.\n{name} smiles.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle happy expression. Baby and MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) looking at each other warmly. MISU sits in front of baby with curious tilted head, bright green eyes meeting baby's gaze. SETTING: Loving nursery WIDE VIEW, warm golden light streaming in, soft pastel colors, magical sparkles around them. ATMOSPHERE: Sweet connection, first eye contact, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler crouching on the nursery floor, gentle happy expression. Child and MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) looking at each other at eye level warmly. MISU sits in front of child with curious tilted head. SETTING: Loving nursery WIDE VIEW, warm golden light streaming in, soft pastel colors, magical sparkles around them. ATMOSPHERE: Sweet connection, first eye contact, warm golden glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "Toco al gatito con mi mano.\nSu pelito es blandito.\nMe gusta sentirlo.",
                "text_en": "I touch the kitten with my hand.\nIts fur is so soft.\nI like how it feels.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, sweet curious expression, gently reaching out with tiny baby hand to pet MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur). MISU sits still, eyes closed contentedly, enjoying the gentle touch. SETTING: Nursery WIDE VIEW, warm golden soft lighting, soft warm cream and pastel tones, gentle golden sparkles. ATMOSPHERE: Tender moment of first touch, warm golden gentle magic. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler crouching down in the nursery, sweet curious expression, gently reaching out with small hand to pet MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur). MISU sits still, eyes closed contentedly, enjoying the gentle touch. SETTING: Nursery WIDE VIEW, warm golden soft lighting, soft warm cream and pastel tones, gentle golden sparkles. ATMOSPHERE: Tender moment of first touch, warm golden gentle magic. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human."
            },
            {
                "text_es": "El gatito salta y juega.\nHace cosas divertidas.\n{name} ríe feliz.",
                "text_en": "The kitten jumps and plays.\nIt does funny things.\n{name} laughs happily.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on soft nursery floor, joyful expression, watching MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) playing and jumping, chasing a small yarn ball. MISU is mid-leap with fluffy tail excited. SETTING: Playful nursery WIDE VIEW, bright cheerful afternoon light, colorful toys scattered around, magical sparkles everywhere, warm golden sunset colors visible through window. ATMOSPHERE: Pure joy and playfulness, cheerful energy, warm sunset glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU, baby is fully human with smooth human skin only.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing in the nursery, joyful expression, watching MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) playing and jumping, chasing a small yarn ball. MISU is mid-leap with fluffy tail excited. SETTING: Playful nursery WIDE VIEW, bright cheerful afternoon light, colorful toys scattered around, magical sparkles everywhere, warm golden sunset colors visible through window. ATMOSPHERE: Pure joy and playfulness, cheerful energy, warm sunset glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU, child is fully human with smooth human skin only."
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting on a soft blanket, gentle smile, baby's tiny hand gently resting on MISU's back. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up as a ball next to baby, resting contentedly. SETTING: Cozy nursery WIDE VIEW, warm golden afternoon light streaming through window, peaceful calm atmosphere, soft warm cream tones, soft plush toys nearby. ATMOSPHERE: Tender bonding moment, warm golden afternoon glow. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler sitting on the nursery floor on a soft blanket, gentle smile, small hand gently resting on MISU's back. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up as a ball next to child, resting contentedly. SETTING: Cozy nursery WIDE VIEW, warm golden afternoon light streaming through window, peaceful calm atmosphere, soft warm cream tones, soft plush toys nearby. ATMOSPHERE: Tender bonding moment, warm golden afternoon glow. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU curled up next to child, child is fully human."
            },
            {
                "text_es": "La luna sale en el cielo.\nTodo se vuelve tranquilo.\nMISU bosteza despacito.\nYa casi es hora de dormir.",
                "text_en": "The moon rises in the sky.\nEverything becomes quiet.\nMISU yawns softly.\nIt's almost time to sleep.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby sitting by a nursery window at night, watching MISU and the moonlight with calm wonder. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting on the windowsill looking at the moon. SETTING: Peaceful nursery WIDE VIEW, soft warm night lamp glowing warmly in the corner, gentle moonlight streaming through window, stars visible in the night sky, soft lavender and warm cream tones, gentle golden sparkles in the air. ATMOSPHERE: Peaceful nighttime transition, warm magical moonlight glow, calm wonder. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU on windowsill, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler standing by a nursery window at night, watching MISU and the moonlight with calm wonder. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) sitting on the windowsill looking at the moon. SETTING: Peaceful nursery WIDE VIEW, soft warm night lamp glowing warmly in the corner, gentle moonlight streaming through window, stars visible in the night sky, soft lavender and warm cream tones, gentle golden sparkles in the air. ATMOSPHERE: Peaceful nighttime transition, warm magical moonlight glow, calm wonder. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU on windowsill, child is fully human."
            },
            {
                "text_es": "Es hora de descansar.\nMISU se acurruca conmigo.\nCierra los ojos, {name}.\nTe queremos.",
                "text_en": "Time to rest now.\nMISU snuggles close to me.\nClose your eyes, {name}.\nWe love you.",
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby peacefully sleeping in a cozy crib, eyes gently closed. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up sleeping next to baby, both resting on a cloud-soft blanket. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside. ATMOSPHERE: Serene peaceful moonlit calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE baby, only ONE kitten MISU curled up next to baby, baby is fully human.",
                "scene_template_toddler": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CHARACTER: The EXACT SAME toddler from the reference — {gender_word} ({age_display}), {eye_desc}, {skin_tone} skin, softly rounded cheeks, delicate toddler features, natural proportions, large smooth forehead, small delicate ears, tiny rounded nose. WEARING: Plain soft white onesie. ACTION: Toddler peacefully sleeping in a cozy toddler bed, eyes gently closed. MISU (ginger-orange tabby kitten, bright green eyes, tiny pink nose, soft orange striped fur) curled up sleeping next to child, both resting on a cloud-soft blanket. SETTING: Peaceful nursery WIDE VIEW, gentle moonlight streaming through window, soft lavender and cream tones, tiny stars twinkling outside. ATMOSPHERE: Serene peaceful moonlit calm, friendship and love. STRICT: Maintain same face and features as reference. Only ONE toddler, only ONE kitten MISU curled up next to child, child is fully human."
            }
        ],
    },
    "baby_guardian_light": {
        ...
        "age_range": "0-1",
        "use_preview_as_cover": True,
        "companion_action": "A glowing golden orb of warm light floats nearby.",
        "env_desc": "Cozy nursery, soft pastel lavender and cream walls, gentle sparkles floating",
        "atm_desc": "Warm dreamy magical golden light, love and protection, soft luminous colors",
        "companion_strict": "One plain glowing orb. One human baby only.",
        ...
        "pages": [
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Plain soft white onesie. ACTION: Baby lying flat on back on a fluffy white blanket on the nursery floor, tiny arms raised up toward {guardian_light_desc} that hovers gently above, eyes wide with wonder, tiny fingers reaching upward. SETTING: Cozy nursery WIDE VIEW, soft evening light, lavender and cream walls, cream crib visible in background, gentle golden sparkles raining softly from the glowing orb. ATMOSPHERE: First magical moment of wonder and protection, warm golden light. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a featureless plain sphere of warm light only.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Mint green snap onesie. ACTION: Baby crawling energetically across a soft play mat on all fours, reaching toward a colorful soft toy just ahead, while {guardian_light_desc} floats gently above following baby's path and casting a warm protective golden light. Cheerful focused expression. SETTING: Playful nursery WIDE VIEW, cheerful afternoon sunlight through window, pastel play mat, various soft toys scattered around, golden sparkles drifting from the orb above. ATMOSPHERE: Sweet protective warmth, playful guardian energy. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of warm light.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Cozy cream knit onesie. ACTION: Baby lying on back inside the cozy white crib, looking up with peaceful serene expression, tiny hands resting open on the mattress, while {guardian_light_desc} floats above the crib creating a gentle dome of golden sparkles around baby. SETTING: Protected nursery WIDE VIEW, soft lavender and gold tones, cream crib with soft blankets, gentle sparkles forming a glowing protective circle above the crib. ATMOSPHERE: Complete safety and love, warm golden protective halo. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
            ...
            },
            {
                ...
                "scene_template": "Soft luxury digital illustration, fine art children's book style, premium baby memory book. CAST: @image1 = {gender_word} ({age_display}) baby (fully human body, smooth skin, two arms) — match reference exactly. WEARING: Soft pale blue onesie. ACTION: Baby standing inside the crib gripping the crib rail with both tiny hands, face pressed slightly forward, gazing out the nursery window at the night sky with mouth slightly open in awe, while {guardian_light_desc} dances among the stars outside the window, trailing golden sparkles through the night. SETTING: Magical night sky visible through window WIDE VIEW, stars twinkling, golden sparkle trails dancing outside, soft lavender nursery lit by star glow and orb light. ATMOSPHERE: Magical starlight dance, wonder and love. STRICT: Maintain same face and features as reference. Only ONE baby, baby is fully human, glowing orb is a plain smooth sphere of light.",
    ...
    "dragon_friend": {
        ...
        "text_layout": "split",
        "use_preview_as_cover": True,
        "preview_prompt_override": "Disney Pixar 3D style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, curious wonder-filled expression. OUTFIT: Soft blue tunic, brown pants, small boots. ACTION: {gender_word} stands beside a majestic oak tree looking UP in amazement at Spark — a giant emerald baby dragon with golden eyes, chubby round body, tiny wings, cream belly — Spark towers twice as tall over {gender_word}, tilts head curiously DOWN, tiny sparkly smoke from snout. SETTING: Enchanted garden WIDE VIEW, glowing flowers, butterflies, stone path, morning golden sunlight. ATMOSPHERE: Discovery and wonder, warm golden light, magical sparkles. STRICT: ONE {gender_word}, ONE dragon Spark. Spark twice the height of {gender_word}. {gender_word} fully human, normal child anatomy. {style}",
        ...
        "pages": [
            ...
            },
            {
                ...
                "scene_template": "Disney Pixar 3D style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, tender compassionate expression, eyes soft with empathy. OUTFIT: Soft blue tunic with gold embroidery, brown pants, small boots. ACTION: {gender_word} hugs the large belly of {spark_desc}. Spark is TWICE AS TALL so {gender_word} only reaches Spark's belly. Spark has drooping wings, sad golden eyes, tiny tear, lowering its head gently onto {gender_word}'s head for comfort. SETTING: Garden at golden hour WIDE VIEW, warm amber light, autumn leaves, distant mountains. ATMOSPHERE: Bittersweet tenderness, warm golden glow, comfort and promise. STRICT: ONE {gender_word}, ONE dragon Spark. Spark TWICE THE HEIGHT of {gender_word}. {gender_word} fully human, no duplicates. {style}"
            },
            {
    ...
    "centinela_aurora_illustrated": {
        ...
        "use_fixed_scenes": True,
        "scenes_dir": "generated",
        "preview_prompt_override": "Full body portrait of a cheerful {gender_word} (6-7 years old) with {hair_desc}, {eye_desc} and {skin_desc}, {gender_features}, wearing a cozy dark navy explorer jacket with small star-shaped badges, dark pants, comfortable white sneakers and a golden compass on a cord around the neck, kneeling in a moonlit garden. Beside the child is ASTRO - a small magical fox the size of a kitten with vibrant electric blue soft fur, bright white chest, large amber-golden eyes, a long fluffy tail with a softly glowing tip, and a tiny rope collar with a star-shaped gem pendant. Flowers glow blue in the magical light, fireflies float in the air. Children's storybook illustration style, Disney Pixar 3D style, vivid warm colors, magical glowing atmosphere. Pure illustration only, no text, no watermark",
        "content_pages": [
    ...
    "zebra_stripes": {
        ...
        "pages": [
            ...
            },
            {
                ...
                "scene_template": """Disney Pixar 3D style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, peaceful warm smile. OUTFIT: Khaki safari t-shirt, khaki shorts, brown boots. ACTION: The {gender_word} walks on the LEFT of a golden path, {hair_action}, one {skin_tone} hand resting gently on Lila's back at shoulder height. {lila_desc}, walking RIGHT BESIDE the {gender_word}, her head towering above, looking back with a warm smile. SETTING: WIDE panoramic savanna at golden sunset, orange and pink sky, silhouetted acacia trees, golden grass, path into the distance. ATMOSPHERE: Warm farewell, deep friendship, golden light, peaceful ending. STRICT: Only ONE {gender_word}. The {gender_word} is 100% human, two arms, two legs, smooth {skin_tone} skin, NO tail, NO animal features, NO animal ears. {style}"""
            }
        ],
    ...
    "superhero_light": {
        ...
        "text_layout": "split",
        "use_preview_as_cover": True,
        "preview_prompt_override": """Disney Pixar 3D style illustration. CHARACTER: A single {gender_word} ({age_display}), {hair_desc}, {eye_desc}, {skin_tone} skin, calm confident smile. OUTFIT: Deep blue superhero suit, golden star patterns, golden boots, short flowing cape, glowing golden star on chest. ACTION: {gender_word} stands in the LOWER HALF, {skin_tone} hands open at sides, {hair_action}, soft golden light surrounding. SETTING: WIDE VIEW, park at golden hour, green field, sunset sky with pink and orange clouds, golden sparkles. ATMOSPHERE: Heroic moment, warm glow, LOTS OF SKY ABOVE. STRICT: ONE {gender_word}, fully human, smooth {skin_tone} skin. {gender_word} occupies BOTTOM THIRD of image only. {style}""",
...
def get_baby_hair_description(hair_color: str, gender: str = "male") -> str:
    """
    Returns the Gemini-formula CRITICAL Hair block for baby (0-1) portraits.
    Describes hair as microscopic velvet/downy texture to prevent FLUX tuft rendering.
    Dark/saturated colors use shadow-tint approach; vivid colors use faint-tint approach.
    """
    ...
    color_desc, style_type = color_map.get(hair_color, ('warm medium brown', 'normal'))

    if style_type == 'shadow':
        return (
            f"{pronoun} entire head is covered in an extremely fine, almost translucent, downy texture "
            f"that reads as a very subtle dark shadow tint on the scalp surface — so dark and so sparse "
            f"it merges completely with the skin as a shadow-like skin-tone variation rather than visible hair. "
            f"There is absolutely zero visible hair height, zero volume, and zero individual strand displacement "
            f"from the scalp. The scalp texture itself is completely and clearly visible and uninterrupted. "
            f"The contour from the forehead to the nape is a perfectly smooth, continuous, rounded curve with "
            f"zero tufts, zero spikes, and zero directional movement. This coverage is so minimal it appears "
            f"as a slightly deeper pigmentation on the scalp skin, not as a hair layer."
        )
    elif style_type == 'vivid':
        return (
            f"{pronoun} entire head is covered in an extremely fine, almost translucent, downy texture "
            f"with a very subtle pale warm {color_desc} tint — so sparse and flat it appears as a faint "
            f"warm skin-tone variation on the scalp rather than visible hair. There is absolutely zero "
            f"visible hair height, zero volume, and zero individual strand displacement from the scalp. "
            f"The scalp texture itself is completely and clearly visible and uninterrupted. The contour "
            f"from the forehead to the nape is a perfectly smooth, continuous, rounded curve with zero "
            f"tufts, zero spikes, and zero directional movement. The {color_desc} tint is so faint it is "
            f"barely a hint of warmth on the scalp surface, merging fully with the skin contour."
        )
    else:
        return (
            f"{pronoun} entire head is covered in an extremely fine, almost translucent, downy texture "
            f"of {color_desc} newborn fuzz. This fuzz is so sparse and flat that it appears as a microscopic "
            f"velvet layer, integrating with the skin appearance. There is absolutely zero visible hair height, "
            f"zero volume, and zero individual strand displacement from the scalp. The effect is purely a matte, "
            f"velvety skin-tone variation on the scalp, with the scalp texture itself completely and clearly "
            f"visible and uninterrupted. The contour from the forehead to the nape is a perfectly smooth, "
            f"continuous, rounded curve with zero tufts, zero spikes, and zero directional movement. "
            f"The fuzz is so fine it merges with the skin surface contour."
        )


def get_baby_gender_face_desc(gender: str) -> str:
    """CHARACTER descriptor for baby — face/body differentiated by gender."""
    if gender == 'male':
        return "A single baby boy, chubby cheeks, round baby face, sweet curious expression"
    elif gender == 'female':
        return "A single baby girl, long lashes, chubby cheeks, round baby face, sweet curious expression"
    return "A single baby, chubby cheeks, round baby face, sweet curious expression"


def get_baby_hair_desc(hair_length: str, hair_color: str, hair_type: str, gender: str) -> str:
    """Gemini-formula hair descriptor for baby stories (0-24 months).
    Describes hair as surface geometry pressed against the skull — never with height.
    Uses 'absolutely zero [noun]' (not 'no X' / 'never X') for FLUX Dev compatibility.
    """
    color_map = {
    ...
    c = color_map.get(hair_color, 'warm medium brown')
    his_her = 'his' if gender == 'male' else 'her' if gender == 'female' else 'their'
    he_she  = 'He'  if gender == 'male' else 'She'  if gender == 'female' else 'They'

    if hair_length == 'bald':
        return "Completely bald, smooth bare scalp, no hair."

    if hair_length == 'very_little':
        return f"Soft fine {c} baby hair lying flat against scalp, very sparse and thin."

    if hair_length == 'very_short':
        if hair_type in ('afro', 'coily'):
            return f"{c} tiny tight coils pressed flat and even against skull."
        return f"{c} hair cut very close to skull, lying flat."

    if hair_length == 'short':
        if hair_type in ('afro', 'coily'):
            return f"Short {c} natural coily hair shaped close to head."
        if gender == 'male':
            return f"Short {c} baby hair swept neatly to one side, lying flat."
        return f"Short soft {c} baby hair draping gently flat."

    # medium (and any other length)
    if hair_type in ('afro', 'coily'):
        return f"Medium {c} natural coily hair framing the face softly."
    if gender == 'male':
        return f"Medium {c} hair brushed neatly, lying flat."
    return f"Soft medium {c} hair draping gently."


def get_baby_hair_mandate(hair_length: str) -> str:
    """Short punchy hair mandate placed at the VERY START of the prompt.
    FLUX Dev weights early tokens heavily — this primes the model before it sees 'baby'.
    """
    if hair_length == 'bald':
        return "SMOOTH BALD HEAD. ZERO HAIR."
    if hair_length == 'very_little':
        return "VERY SPARSE FINE BABY HAIR FLAT AGAINST SCALP. ZERO HAIR TUFTS."
    if hair_length == 'very_short':
        return "VERY SHORT CLOSE-CROPPED HAIR. FLAT AGAINST SKULL. ZERO RAISED VOLUME."
    if hair_length == 'short':
        return "SHORT FLAT HAIR PRESSED AGAINST HEAD. ZERO CROWN TUFTS."
    return ""


def get_baby_hair_strict(hair_length: str) -> str:
    """STRICT hair constraint — compact for FLUX 2 Dev 256-token limit."""
    if hair_length == 'bald':
        return "Zero hair coverage."
    if hair_length == 'very_little':
        return "Zero tufts, zero spikes, zero topknots."
    if hair_length in ('very_short', 'short'):
        return "Zero raised crown volume."
    return ""


def get_baby_pose_desc(child_age_months: int) -> str:
    """Age-appropriate pose for baby/toddler (child_age_months is the month value)."""
    if child_age_months <= 3:
        return "Baby lying on back on soft blanket, tiny arms and legs relaxed."
    elif child_age_months <= 7:
        return "Baby propped sitting on soft blanket, cheerful curious expression."
    elif child_age_months <= 12:
        return "Baby sitting upright on soft blanket, chubby legs forward, bright curious expression."
    elif child_age_months <= 18:
        return "Toddler on all fours on soft surface, looking up with happy expression."
    return "Toddler standing on small feet on soft surface, joyful curious expression."


def get_baby_clothing_desc(gender: str) -> str:
    """Clothing description for baby."""
    if gender == 'male':
        return "a soft cream-white ribbed cotton onesie, simple and boyish"
    elif gender == 'female':
        return "a soft cream-white ribbed cotton onesie, simple and delicate"
    return "a soft cream-white ribbed cotton onesie"


def get_baby_anatomy_strict(gender: str, child_age_months: int) -> str:
    """Anatomy STRICT block with age-appropriate pose constraint."""
    base = "Fully human baby, small proportionate ears, two arms, two legs."
    if child_age_months <= 7:
        base += " Cannot sit unsupported or stand."
    elif child_age_months <= 11:
        base += " Cannot stand or walk."
    elif child_age_months <= 17:
        base += " Cannot walk independently yet."
    return base
    ...
    if length == 'very_short':
        if gender == 'male':
            if hair_type in ('afro', 'coily'):
                ...
                return f"{c} contemporary boys induction cut, hair clipped to a uniform extremely close length all over, gentle wave texture pressed completely flat against the scalp, scalp clearly visible through the very short uniform cut, zero volume, zero height, no raised strands"
            else:
                return f"{c} contemporary boys induction cut, hair clipped to a uniform extremely close length all over, hair completely flat against the scalp with zero raised strands, scalp clearly visible through the very short uniform cut, zero volume, zero height"
        else:
            if hair_type in ('afro', 'coily'):
    ...
    if length == 'short':
        if gender == 'male':
            if hair_type in ('afro', 'coily'):
                ...
                if traits.get('is_baby_story', False):
                    return f"{c} short neat baby wavy hair lying flat against the head, gentle natural wave, clean simple cut, no volume, no flyaways, hair stays close to the scalp"
                ...
                if traits.get('is_baby_story', False):
                    return f"{c} short neat baby hair lying flat and even against the head, clean simple cut, hair lies close to the scalp with no volume and no flyaways"
...
def get_hair_strict(traits: dict) -> str:
    """Return a HAIR STRICT constraint for injection into STRICT prompt block."""
    length = traits.get('hair_length', 'medium')
    hair_type = traits.get('hair_type', 'straight')
    type_suffix = {
        'straight': " Hair is completely straight with no waves or curls.",
        'wavy': " Hair has natural waves, not straight and not tightly curled.",
        'curly': " Hair has natural curls, not straight or wavy.",
        'afro': " Hair is tightly coiled afro texture, full volume.",
        'coily': " Hair is tightly coiled natural coily texture, full volume.",
    }.get(hair_type, "")
    if length == 'bald':
        ...
        return f"HAIR STRICT: child has medium-length hair reaching the shoulders.{type_suffix}"
...
def get_hair_action(traits: dict) -> str:
    ...
    if length == 'bald':
        return "completely smooth bald head, no hair at all, perfectly round smooth scalp"
    elif length == 'very_little':
        return "completely bald smooth head, no hair whatsoever, perfectly round smooth scalp"
    elif length == 'very_short':
        if hair_type == 'afro':
            return "tiny tight afro kept very close to the head, cropped low"
        elif gender == 'male':
            return "very short hair, close-cropped, neatly trimmed"
        else:
            return "very short pixie cut, neatly in place"
    elif length == 'short':
        if gender == 'male':
            return "short textured hair slightly tousled naturally on top"
        ...
        if hair_type == 'afro':
            return "medium afro neatly shaped"
        elif hair_type == 'curly':
...
def prepare_story(story_id: str, child_name: str, gender: str, traits: dict, lang: str = 'es') -> dict:
    ...
    for i, page in enumerate(source_pages, 1):
        ...
        if is_illustrated_book and 'fixed_scene' in page:
            ...
            is_toddler = is_baby_story and child_age >= 12  # child_age in months for baby stories
    ...
    if hair_length == 'very_little' and 'STRICT:' in prompt:
        if is_baby_story:
            prompt = prompt.replace(
                'STRICT:',
                'STRICT: Baby head appears bald — smooth rounded scalp with only a microscopic ultra-fine '
                'peach fuzz dusting barely covering the skin, scalp skin texture fully visible, '
                'scalp shape clearly defined, hair density at zero,'
            )
        else:
...
def enforce_gender_clothing(prompt: str, gender: str) -> str:
    ...
    if gender == 'male':
        ...
        return prompt
    if 'STRICT:' in prompt:
        prompt = prompt.replace('STRICT:', 'STRICT:' + rule, 1)
    else:
        prompt += rule
    return prompt
...
def get_scene_prompts(story_id: str, child_name: str, gender: str, traits: dict, use_reference_image: bool = False) -> list:
    ...
    # For baby stories, FLUX 2 Dev uses the preview photo as reference.
    # Only reinforce with hair color — let the photo handle style/length.
    if is_baby_story:
        _baby_color_map = {
            'black': 'jet black', 'brown': 'medium brown', 'light_brown': 'warm light brown (caramel-honey tone)',
            'blonde': 'dark dirty blonde', 'very_light_blonde': 'pale platinum blonde',
    ...
    for page in story['pages']:
        ...
        if is_baby_story:
            ...
            # Skip injection if template already uses CAST: @image1 format (baby_soft_world).
            if 'CHARACTER:' not in prompt and 'CAST:' not in prompt:
                char_anchor = (
...
def get_closing_prompt(story_id: str, child_name: str, gender: str, traits: dict, use_reference_image: bool = False) -> str:
    ...
    if use_reference_image:
        ...
        # Neutralize hair_action too — reference image handles hair appearance,
        # a detailed hair_action would conflict with and override the reference.
        hair_action = "gazing peacefully at the sky"
    
    default_age = '6' if is_baby_story else '5'  # 6 months default for baby stories
    child_age = int(traits.get('child_age', default_age))
    if is_baby_story:
        _m = child_age
        if _m <= 3:    age_display = "1-3 month old"
        elif _m <= 7:  age_display = "4-7 month old"
        elif _m <= 12: age_display = "8-12 month old"
        elif _m <= 18: age_display = "12-18 month old"
        else:          age_display = "18-24 month old"
    else:
        age_display = f"{child_age} year old" if child_age > 0 else "baby"
